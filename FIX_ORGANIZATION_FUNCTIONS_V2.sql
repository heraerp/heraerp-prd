-- Fixed Organization Functions to match actual schema
...
-- Fixed: create_organization_with_owner to use correct schema
...
BEGIN
    ...
    INSERT INTO core_relationships (
        id, organization_id, from_entity_id, to_entity_id, relationship_type, metadata, created_at, updated_at
    ) VALUES (
        gen_random_uuid(),
        v_org_id,
        v_user_entity_id,
