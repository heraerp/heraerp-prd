...
async function testUsers() {
  ...
  for (const testUser of HAIRTALKZ_USERS) {
    ...
    console.log(`   Organizations: ${authContext.organization_count}`)
    console.log(`   Platform Admin: ${authContext.is_platform_admin}`)
    console.log(`   Default Org: ${authContext.default_organization_id || 'None'}`)
