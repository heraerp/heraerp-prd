-- HERA Complete RLS Fix
-- This script removes core_clients references and sets up RLS functions

-- ========================================
-- PART 1: Remove core_clients reference
-- ========================================
...
-- Update RLS Policies for core_dynamic_data
...
-- Update RLS Policies for core_organizations
...
-- Update RLS Policies for core_entities
...
-- Update RLS Policies for universal_transactions
...
-- ========================================
-- This script:
-- 1. Removes the core_clients foreign key constraint
-- 2. Creates the hera_current_org_id() function
-- 3. Updates RLS policies to handle demo sessions
-- 4. Fixes the "unrecognized configuration parameter" errors