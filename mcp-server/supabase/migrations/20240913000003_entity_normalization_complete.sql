-- ================================================================================================
-- HERA Entity Normalization DNA - Complete Safe Version
-- ================================================================================================
...
-- Add normalized names for existing entities
DO $$
DECLARE
    v_entity record;
    v_normalized_name text;
    v_count integer := 0;
BEGIN
    -- Add normalized names for entities that don't have them
    FOR v_entity IN 
        SELECT e.* 
        FROM core_entities e
    ...
    IF v_count > 0 THEN
        RAISE NOTICE 'Normalized % existing entities', v_count;
    END IF;
END $$;
