...
export declare const ORGANIZATION_ID_REGEX: RegExp;
...
export declare const createEntityId: typeof validateEntityId;
export declare const createTransactionId: typeof validateTransactionId;
/**
