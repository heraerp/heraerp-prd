...
/**
 * Rebate Accrual Transaction Page
 * Smart Code: HERA.FINANCE.TXN.REBATE.ACCRUAL.MAIN.v1
...
export default function CreateRebate AccrualPage() {
  ...
  return (
    <EnterpriseCreatePage
      title={`Create ${Rebate Accrual}`}
      subtitle="Periodic rebate accrual calculation and posting"
      breadcrumb="Enterprise > Transactions > Rebate Accrual"
      sections={sections}
