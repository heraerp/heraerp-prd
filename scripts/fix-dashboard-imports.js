...
console.log('🔧 Fixing dashboard component imports...\n');

// Find all TypeScript/TSX files in src/components/dashboard
const files = glob.sync('src/components/dashboard/**/*.{ts,tsx}');
