...
export const defaultMessages: Record<string, string> = {
  ...
  'ui.onboard.console.dashboard.welcome.body':
    "This quick tour highlights the key areas you'll use every day. Let's explore the powerful features of your universal business platform.",

  'ui.onboard.console.dashboard.filters.title': 'Filter Your Data',
  'ui.onboard.console.dashboard.filters.body':
    'Narrow results by date range, organization, and Smart Codes. These filters work across all six universal tables.',

  'ui.onboard.console.dashboard.kpis.title': 'KPI Cards',
  'ui.onboard.console.dashboard.kpis.body':
    'Key Performance Indicators summarize your universal transactions at a glance. Each card uses Smart Codes for intelligent business context.',

  'ui.onboard.console.dashboard.create.title': 'Create an Entity',
  'ui.onboard.console.dashboard.create.body':
    'Use this button to add any business object via core_entities table. Dynamic fields let you customize without schema changes.',

  // CRM Module Tour
  'ui.onboard.crm.customers.title': 'Customer Management',
  'ui.onboard.crm.customers.body':
    'Manage all customer entities with unlimited custom fields. Every customer is an entity in the universal architecture.',

  'ui.onboard.crm.pipeline.title': 'Sales Pipeline',
  'ui.onboard.crm.pipeline.body':
    'Track opportunities through stages using relationships. No status columns needed - everything flows through core_relationships.',

  // Financial Module Tour
  'ui.onboard.financial.gl.title': 'General Ledger',
  'ui.onboard.financial.gl.body':
    'Chart of Accounts with IFRS compliance built-in. Every GL account is an entity with Smart Code intelligence.',

  'ui.onboard.financial.transactions.title': 'Universal Transactions',
  'ui.onboard.financial.transactions.body':
    'All business activities flow through universal_transactions table. Automatic GL posting via Smart Codes.',

  // Inventory Module Tour
  'ui.onboard.inventory.products.title': 'Product Catalog',
  'ui.onboard.inventory.products.body':
    'Products are entities with dynamic specifications. Add unlimited attributes without database changes.',

  'ui.onboard.inventory.movements.title': 'Stock Movements',
  'ui.onboard.inventory.movements.body':
    'Track inventory through universal transactions. Real-time stock levels with complete audit trail.',

  // HR Module Tour
  'ui.onboard.hr.employees.title': 'Employee Records',
  'ui.onboard.hr.employees.body':
    'Employees are entities with dynamic HR data. Organizational structure through relationships.',

  'ui.onboard.hr.payroll.title': 'Payroll Processing',
  'ui.onboard.hr.payroll.body':
    'Payroll runs create universal transactions. Automatic journal entries with Smart Code routing.',

  // Settings Tour
  'ui.onboard.settings.organization.title': 'Organization Settings',
  'ui.onboard.settings.organization.body':
    'Configure your organization details. Sacred boundary ensures complete data isolation.',

  'ui.onboard.settings.users.title': 'User Management',
  'ui.onboard.settings.users.body':
    'Users are entities too! Manage permissions through dynamic role assignments.',

  // Progressive PWA Tours
  'ui.onboard.progressive.welcome.title': 'Progressive Mode',
  'ui.onboard.progressive.welcome.body':
    '30-day trial with full functionality. All data stored locally and syncs when you upgrade.',

  'ui.onboard.progressive.upgrade.title': 'Upgrade to Production',
  'ui.onboard.progressive.upgrade.body':
    'Convert to full production with custom subdomain. Zero data loss - everything migrates seamlessly.',
 ...
 */
export function extractTourMessageKeys(
