    ...
    mutationFn: async (input: {
      ...
      if (input.price !== undefined && input.price !== null) {
        ...
        fields.push({
          field_name: 'currency',
          field_type: 'text',
          field_value: input.currency ?? 'AED'
        })
      }
    ...
    mutationFn: async (input: {
      ...
      if (input.qty_on_hand !== undefined)
        fields.push({
          field_name: 'qty_on_hand',
          field_type: 'number',
          field_value_number: input.qty_on_hand
        })
