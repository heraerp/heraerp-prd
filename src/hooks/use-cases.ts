...
export function useActionVary(id: string) {
  ...
  return useMutation({
    mutationFn: (data: CaseActionVaryPayload) => casesApi.action(currentOrgId!, id, 'vary', data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: caseKeys.detail(id) })
      queryClient.invalidateQueries({ queryKey: caseKeys.timeline(id) })
      queryClient.invalidateQueries({ queryKey: caseKeys.lists() })
...
export function useActionWaive(id: string) {
  ...
  return useMutation({
    mutationFn: (data: CaseActionWaivePayload) => casesApi.action(currentOrgId!, id, 'waive', data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: caseKeys.detail(id) })
      queryClient.invalidateQueries({ queryKey: caseKeys.timeline(id) })
      queryClient.invalidateQueries({ queryKey: caseKeys.lists() })
...
export function useActionClose(id: string) {
  ...
  return useMutation({
    mutationFn: (data: CaseActionClosePayload) => casesApi.action(currentOrgId!, id, 'close', data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: caseKeys.detail(id) })
      queryClient.invalidateQueries({ queryKey: caseKeys.timeline(id) })
      queryClient.invalidateQueries({ queryKey: caseKeys.lists() })
