...
export const queryKeys = {
  runs: {
    ...
    list: (orgId?: OrgId, params?: ListQueryParams) => 
      ['runs', 'list', orgId, params] as const,
    detail: (orgId?: OrgId, runId?: string) => 
      ['runs', 'detail', orgId, runId] as const,
    timeline: (orgId?: OrgId, runId?: string) => 
      ['runs', 'timeline', orgId, runId] as const,
  },
  playbooks: {
    ...
    detail: (orgId?: OrgId, id?: string) => 
      ['playbooks', 'detail', orgId, id] as const,
    versions: (orgId?: OrgId, id?: string) => 
      ['playbooks', 'versions', orgId, id] as const,
  },
  organizations: {
