    ...
    <div className="docs-container">
      <nav className="docs-sidebar">
        <div className="docs-nav-section">
          ...
          <Link href="/docs/overview" className="docs-nav-link">
            Overview
          </Link>
          <Link href="/docs/quickstart" className="docs-nav-link">
            Quick Start
          </Link>
          <Link href="/docs/methodology" className="docs-nav-link">
            Implementation Methodology
          </Link>
          <Link href="/docs/architecture" className="docs-nav-link">
            Architecture
          </Link>
        </div>
        ...
        <div className="docs-nav-section">
          ...
          <Link href="/docs/features/universal-api" className="docs-nav-link">
            Universal API
          </Link>
          <Link href="/docs/features/multi-tenant" className="docs-nav-link">
            Multi-Tenant SaaS
          </Link>
        ...
        <div className="docs-nav-section">
          ...
          <Link href="/docs/features/ifrs-compliance" className="docs-nav-link">
            IFRS Compliance
          </Link>
        </div>
        ...
        <div className="docs-nav-section">
          ...
          <Link href="/docs/industries/restaurant" className="docs-nav-link">
            Restaurant
          </Link>
          <Link href="/docs/industries/healthcare" className="docs-nav-link">
            Healthcare
          </Link>
          <Link href="/docs/industries/retail" className="docs-nav-link">
            Retail
          </Link>
          <Link href="/docs/industries/manufacturing" className="docs-nav-link">
            Manufacturing
          </Link>
        </div>
        ...
        <div className="docs-nav-section">
          ...
          <Link href="/docs/integrations/whatsapp" className="docs-nav-link">
            WhatsApp Business
          </Link>
          <Link href="/docs/integrations/progressive-pwa" className="docs-nav-link">
            Progressive PWA
          </Link>
          <Link href="/docs/integrations/mcp-server" className="docs-nav-link">
            MCP Server
          </Link>
        </div>
        ...
        <div className="docs-nav-section">
          ...
          <Link href="/docs/api/rest" className="docs-nav-link">
            REST API
          </Link>
          <Link href="/docs/api/typescript-client" className="docs-nav-link">
            TypeScript Client
          </Link>
          <Link href="/docs/api/webhooks" className="docs-nav-link">
            Webhooks
          </Link>
        </div>
      </nav>
      ...
      <main className="docs-main">
        ...
        <div className="docs-feature-grid">
          <div className="docs-feature-card">
            ...
            <p className="docs-card-description">
              21-day implementation journey with MCP orchestration. From requirements to production
          ...
          <div className="docs-feature-card">
            ...
            <p className="docs-card-description">
              Revolutionary architecture handles infinite business complexity. Learn how HERA's
          ...
          <div className="docs-feature-card">
            ...
            <p className="docs-card-description">
              Production-ready multi-tenant system with subdomain routing and perfect data
              isolation.
            </p>
          ...
          <div className="docs-feature-card">
            ...
            <p className="docs-card-description">
              Pre-configured solutions for restaurant, healthcare, retail, and manufacturing
              industries.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <ul className="space-y-1 text-sm">
                <li>
                  <Link
                    href="/docs/features/auto-journal"
                    className="text-accent-fg hover:underline"
                  >
                    Auto-Journal Engine
                  </Link>
                ...
                <li>
                  <Link href="/docs/features/budgeting" className="text-accent-fg hover:underline">
                    Universal Budgeting
                  </Link>
                </li>
                <li>
                  <Link
                    href="/docs/features/ifrs-compliance"
                    className="text-accent-fg hover:underline"
                  >
                    IFRS Compliance
                  </Link>
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li>
                  <Link href="/docs/api/webhooks" className="text-accent-fg hover:underline">
                    Webhooks
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li>
                  <Link
                    href="/docs/methodology/complete-guide"
                    className="text-accent-fg hover:underline"
                  >
                    Complete Guide (PDF)
                  </Link>
                ...
                <li>
                  <Link
                    href="/docs/methodology/detailed-flow"
                    className="text-accent-fg hover:underline"
                  >
                    Visual Diagrams
                  </Link>
                ...
                <li>
                  <Link href="/docs/quickstart" className="text-accent-fg hover:underline">
                    Quick Start
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li>
                  <Link href="/docs/overview" className="text-accent-fg hover:underline">
                    Overview
                  </Link>
                </li>
                <li>
                  <a href="mailto:support@heraerp.com" className="text-accent-fg hover:underline">
                    Contact Support
                  </a>
                </li>
              </ul>
        ...
        <div className="mt-8 flex items-center justify-between text-sm text-muted-foreground">
          ...
          <div>Built with HERA Universal Architecture</div>
        </div>
      </main>
    </div>
  )
