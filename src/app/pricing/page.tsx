...
export const metadata: Metadata = {
  ...
  description: 'Configure your HERA ERP solution and get transparent pricing based on your specific needs. No hidden costs, just honest scoping.',
};
...
function ValueProps() {
  const props = [
    ...
    { icon: "📊", title: "Pay for What You Use", desc: "Module-based pricing aligned to your needs" },
    ...
    <>
      ...
      <main className="w-full">
          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="ink-muted text-xl md:text-2xl max-w-3xl mx-auto mb-10">
                No hidden fees. No surprise costs. Configure your exact needs and get a transparent quote instantly.
                Start with what you need, scale when you're ready.
              </p>

              <div className="flex flex-wrap justify-center gap-4">
                <Link href="#configurator" className="px-6 py-3 rounded-xl text-base font-medium bg-gradient-to-r from-indigo-500 to-purple-600 text-white hover:from-indigo-600 hover:to-purple-700 border border-border shadow-lg hover:shadow-xl transition-all">
                  Build Your Solution
                </Link>
                <Link href="/book-a-meeting" className="px-6 py-3 rounded-xl text-base font-medium bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 border border-border transition-all">
                  Talk to Sales
                </Link>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-14">
              ...
              <p className="ink-muted text-lg max-w-2xl mx-auto">
                Our pricing model is designed to be fair, flexible, and aligned with your business growth
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              <div className="group relative">
                ...
                <div className="relative card-glass p-8 rounded-2xl border border-border group-hover:border-indigo-500/30 transition-all duration-300">
                  ...
                  <p className="ink-muted text-sm leading-relaxed mb-4">
                    Pay only for the modules you use. Start with essentials and add capabilities as your business grows.
                  </p>
              ...
              <div className="group relative">
                ...
                <div className="relative card-glass p-8 rounded-2xl border border-border group-hover:border-purple-500/30 transition-all duration-300">
                  ...
                  <p className="ink-muted text-sm leading-relaxed mb-4">
                    Timeline and complexity based on your actual needs. Most implementations go live in 2-4 weeks.
                  </p>
              ...
              <div className="group relative">
                ...
                <div className="relative card-glass p-8 rounded-2xl border border-border group-hover:border-emerald-500/30 transition-all duration-300">
                  ...
                  <p className="ink-muted text-sm leading-relaxed mb-4">
                    Choose your support level and integration needs. Upgrade or downgrade anytime as requirements change.
                  </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="relative">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                {[
                  { icon: "📋", title: "Kickoff", desc: "Requirements gathering and planning", time: "Day 1-3", color: "from-blue-500 to-indigo-600" },
                  { icon: "⚙️", title: "Configure", desc: "Setup modules and workflows", time: "Week 1-2", color: "from-indigo-500 to-purple-600" },
                  { icon: "✅", title: "Validate", desc: "Test with your team", time: "Week 2-3", color: "from-purple-500 to-pink-600" },
                  { icon: "🎯", title: "Go Live", desc: "Launch to production", time: "Week 3-4", color: "from-emerald-500 to-cyan-600" }
                ].map((step, idx) => (
                  <div key={idx} className="relative group">
                    ...
                    <div className="relative bg-white dark:bg-slate-900 p-6 rounded-2xl border border-border shadow-lg group-hover:shadow-xl transition-all duration-300 h-full">
                      <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${step.color} flex items-center justify-center text-white text-3xl mb-4 mx-auto shadow-lg`}>
                        {step.icon}
                      </div>
        ...
        <section className="py-16 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-10">
              <h3 className="ink text-2xl font-bold mb-8">Trusted by Forward-Thinking Businesses</h3>
            </div>
        ...
        <section className="relative py-32 px-6 overflow-hidden">
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-tl from-purple-600/40 via-pink-600/30 to-rose-600/40 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1s'}} />
          ...
          <div className="relative max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-12 text-gray-300 max-w-4xl mx-auto leading-relaxed font-light">
                ...
                <span className="text-white font-medium"> Experience HERA's power with real data testing.</span>
              </p>
