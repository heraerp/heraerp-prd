    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <CardKpi
          ...
          hint="Click to view"
          onClick={() =>
            router.push('/examples/transactions?transaction_type=invoice&status=pending')
          }
        />
        ...
        <CardKpi
          ...
          hint="Last 30 days"
          onClick={() =>
            router.push('/examples/transactions?transaction_type=order&status=completed')
          }
        />
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-4 bg-blue-50 rounded-lg">
          ...
          <ul className="space-y-1 text-sm text-blue-700">
            <li>
              •{' '}
              <a href="/examples/transactions" className="underline">
                Transaction Worklist
              </a>
            </li>
            <li>
              •{' '}
              <a href="/examples/entities?type=customer" className="underline">
                Customer List
              </a>
            </li>
            <li>
              •{' '}
              <a href="/examples/entities?type=product" className="underline">
                Product Catalog
              </a>
            </li>
          </ul>
        ...
        <div className="p-4 bg-green-50 rounded-lg">
          ...
          <ul className="space-y-1 text-sm text-green-700">
            <li>
              •{' '}
              <a href="/examples/sales-order/new" className="underline">
                New Sales Order
              </a>
            </li>
            <li>
              •{' '}
              <a href="/examples/create-transaction" className="underline">
                Create Transaction (Any Type)
              </a>
            </li>
            <li>
              •{' '}
              <a
                href="/examples/create-transaction?smart_code=HERA.FIN.AR.TXN.INV.V1"
                className="underline"
              >
                New Invoice
              </a>
