...
export default function RunDetailPage({
  ...
  const { data: timeline, isLoading: timelineLoading, isError: timelineError } = useRunTimeline(params.runId, currentOrgId);
      ...
      <div className="max-w-4xl">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600">{run.playbook_name} - {params.runId}</p>
          </div>
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Basic details about this playbook execution
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div>
                ...
                {run.step_count && (
                  <p className="text-sm text-gray-600">
                    {timeline?.filter(e => e.event_type === 'step_completed').length || 0} of {run.step_count} steps
                  </p>
                )}
              </div>
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Chronological events for this run
            </CardDescription>
          </CardHeader>
          <CardContent>
