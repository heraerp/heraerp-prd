...
export async function POST(request: NextRequest) {
  try {
      ...
      const demoEvents = [
        {
          ...
          description:
            'Free health screenings, wellness resources, and educational workshops for the community.',
        ...
        },
        {
          ...
          description:
            'Join us for an interactive session on the upcoming fiscal year budget priorities.',
          ...
          const fields = [
            {
              ...
              field_value_text: ebEvent.is_online ? 'webinar' : 'conference'
            },
    ...
    return NextResponse.json({ error: 'Failed to sync Eventbrite data' }, { status: 500 })
  }
}
