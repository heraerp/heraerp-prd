  ...
  try {
    switch (action) {
      ...
      case 'historical':
        ...
        const period = searchParams.get('period') as '1d' | '5d' | '1mo' | '3mo' | '6mo' | '1y' | '2y' | '5y';
      ...
      default:
        return NextResponse.json(
          { success: false, error: 'Invalid action. Available: overview, quote, quotes, historical, search, portfolio' },
          { status: 400 }
        );
    }
  } catch (error) {
