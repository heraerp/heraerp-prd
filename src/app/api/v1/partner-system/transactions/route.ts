...
/**
 * Universal partner-system management module - transactions API
...
export async function GET(request: NextRequest) {
  try {
    ...
    const entities = await heraApi.getEntities('partner-system_transactions', {
    ...
    console.error('PARTNER-SYSTEM transactions API error:', error)
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    const newEntity = await heraApi.createEntity({
      organization_id,
      entity_type: 'partner-system_transactions',
    ...
    console.error('PARTNER-SYSTEM transactions creation error:', error)
    return NextResponse.json(
