...
/**
 * Universal partner-system management module - reports API
...
export async function GET(request: NextRequest) {
  try {
    ...
    const entities = await heraApi.getEntities('partner-system_reports', {
    ...
    console.error('PARTNER-SYSTEM reports API error:', error)
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    const newEntity = await heraApi.createEntity({
      organization_id,
      entity_type: 'partner-system_reports',
    ...
    console.error('PARTNER-SYSTEM reports creation error:', error)
    return NextResponse.json(
