...
/**
 * Restaurant suppliers that makes money - entities API
 * Generated by HERA Module Generator
 * 
 * Customer-focused API that just works
 */

// GET /suppliers/entities - Fetch items using universal schema
...
// POST /suppliers/entities - Create item using universal schema
