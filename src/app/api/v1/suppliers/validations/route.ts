...
/**
 * Restaurant suppliers that makes money - validations API
 * Generated by HERA Module Generator
 * 
 * Customer-focused API that just works
 */

// GET /suppliers/validations - Fetch items using universal schema
...
// POST /suppliers/validations - Create item using universal schema
