...
/**
 * Restaurant suppliers that makes money - reports API
 * Generated by HERA Module Generator
 * 
 * Customer-focused API that just works
 */

// GET /suppliers/reports - Fetch items using universal schema
...
// POST /suppliers/reports - Create item using universal schema
