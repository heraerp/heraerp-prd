...
/**
 * Universal inventory management module - validations API
...
export async function GET(request: NextRequest) {
  try {
    ...
    const entities = await heraApi.getEntities('inventory_validations', {
    ...
    console.error('INVENTORY validations API error:', error)
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    const newEntity = await heraApi.createEntity({
      organization_id,
      entity_type: 'inventory_validations',
    ...
    console.error('INVENTORY validations creation error:', error)
    return NextResponse.json(
