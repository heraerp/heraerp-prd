...
/**
 * Restaurant staff that makes money - reports API
 * Generated by HERA Module Generator
 * 
 * Customer-focused API that just works
 */

// GET /staff/reports - Fetch items using universal schema
...
// POST /staff/reports - Create item using universal schema
