...
/**
 * Restaurant staff that makes money - validations API
 * Generated by HERA Module Generator
 * 
 * Customer-focused API that just works
 */

// GET /staff/validations - Fetch items using universal schema
...
// POST /staff/validations - Create item using universal schema
