...
/**
 * Restaurant staff that makes money - entities API
 * Generated by HERA Module Generator
 * 
 * Customer-focused API that just works
 */

// GET /staff/entities - Fetch items using universal schema
...
// POST /staff/entities - Create item using universal schema
