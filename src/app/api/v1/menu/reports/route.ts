...
/**
 * Universal menu management module - reports API
...
export async function GET(request: NextRequest) {
  try {
    ...
    const entities = await heraApi.getEntities('menu_reports', {
    ...
    console.error('MENU reports API error:', error)
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('MENU reports creation error:', error)
    return NextResponse.json(
