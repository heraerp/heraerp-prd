...
/**
 * Universal menu management module - transactions API
...
export async function GET(request: NextRequest) {
  try {
    ...
    const entities = await heraApi.getEntities('menu_transactions', {
    ...
    console.error('MENU transactions API error:', error)
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('MENU transactions creation error:', error)
    return NextResponse.json(
