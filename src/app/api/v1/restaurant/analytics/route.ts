...
function getTopItemsForTimeRange(timeRange: string) {
  switch (timeRange) {
    ...
    case 'week':
      return [
        { name: 'Margherita Pizza', orders: 298, revenue: 8940.00, margin: 65 },
        { name: 'House Wine', orders: 312, revenue: 4680.00, margin: 70 },
        { name: 'Caesar Salad', orders: 243, revenue: 3645.00, margin: 75 },
        { name: 'Grilled Salmon', orders: 147, revenue: 5145.00, margin: 55 },
        { name: 'Chocolate Cake', orders: 189, revenue: 2268.00, margin: 82 }
      ]
    case 'month':
      return [
        { name: 'Margherita Pizza', orders: 1245, revenue: 37350.00, margin: 65 },
        { name: 'House Wine', orders: 1387, revenue: 20805.00, margin: 70 },
        { name: 'Caesar Salad', orders: 1098, revenue: 16470.00, margin: 75 },
        { name: 'Grilled Salmon', orders: 623, revenue: 21805.00, margin: 55 },
        { name: 'Pasta Carbonara', orders: 834, revenue: 20850.00, margin: 68 }
      ]
    default:
      return []
  }
...
function getRecentTransactionsForTimeRange(timeRange: string) {
  const baseTransactions = [
    { id: 'TXN-001', type: 'sale', amount: 145.50, status: 'completed' },
    { id: 'TXN-002', type: 'purchase', amount: -285.00, status: 'posted' },
    { id: 'TXN-003', type: 'sale', amount: 89.25, status: 'completed' },
    { id: 'TXN-004', type: 'payroll', amount: -1200.00, status: 'posted' },
