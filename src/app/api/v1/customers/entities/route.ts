...
/**
 * Restaurant customers that makes money - entities API
 * Generated by HERA Module Generator
 * 
 * Customer-focused API that just works
 */

// GET /customers/entities - Fetch items using universal schema
...
// POST /customers/entities - Create item using universal schema
