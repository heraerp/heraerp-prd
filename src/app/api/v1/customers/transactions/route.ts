...
/**
 * Restaurant customers that makes money - transactions API
 * Generated by HERA Module Generator
 * 
 * Customer-focused API that just works
 */

// GET /customers/transactions - Fetch items using universal schema
...
// POST /customers/transactions - Create item using universal schema
export async function POST(request: NextRequest) {
  try {
    ...
    const finalEntityCode = entity_code || `CUS-${entity_type.toUpperCase().slice(0,3)}-${Date.now().toString().slice(-6)}`
