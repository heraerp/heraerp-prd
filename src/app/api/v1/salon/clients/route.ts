...
const log = {
  ...
  error: (message: string, error?: any) => console.error(`[SALON-CLIENTS ERROR] ${message}`, error || ''),
...
export async function POST(request: NextRequest) {
  try {
    ...
    const dynamicFields = [
      ...
      { field_name: 'birth_date', field_value_date: birthDate, smart_code: 'HERA.SALON.CLIENT.BIRTHDATE.v1' },
      { field_name: 'preferred_stylist', field_value_text: preferredStylist || '', smart_code: 'HERA.SALON.CLIENT.STYLIST.v1' },
      { field_name: 'notes', field_value_text: notes || '', smart_code: 'HERA.SALON.CLIENT.NOTES.v1' },
      { field_name: 'loyalty_points', field_value_number: 0, smart_code: 'HERA.SALON.CLIENT.LOYALTY.v1' },
      { field_name: 'total_spent', field_value_number: 0, smart_code: 'HERA.SALON.CLIENT.SPENT.v1' },
      { field_name: 'visit_count', field_value_number: 0, smart_code: 'HERA.SALON.CLIENT.VISITS.v1' },
      { field_name: 'allergies', field_value_text: allergies || '', smart_code: 'HERA.SALON.CLIENT.ALLERGIES.v1' },
      { field_name: 'preferences', field_value_text: preferences || '', smart_code: 'HERA.SALON.CLIENT.PREFERENCES.v1' }
    ].filter(field => field.field_value_text !== undefined || field.field_value_number !== undefined || field.field_value_date !== undefined)
