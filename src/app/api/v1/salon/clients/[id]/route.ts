...
export async function GET(
  ...
  try {
    ...
    const transformedClient = {
      ...
      loyaltyPoints: dynamicData.find(d => d.field_name === 'loyalty_points')?.field_value_number || 0,
      preferredStylist: dynamicData.find(d => d.field_name === 'preferred_stylist')?.field_value_text || '',
