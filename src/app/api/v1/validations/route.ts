...
export async function GET(request: NextRequest) {
  try {
    ...
    const entities = await heraApi.getEntities('financial_validations', {
    ...
    console.error('FINANCIAL validations API error:', error)
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    const newEntity = await heraApi.createEntity({
      organization_id,
      entity_type: 'financial_validations',
    ...
    console.error('FINANCIAL validations creation error:', error)
    return NextResponse.json(
