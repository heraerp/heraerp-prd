...
/**
 * Universal software-company management module - reports API
...
export async function GET(request: NextRequest) {
  try {
    ...
    const entities = await heraApi.getEntities('software-company_reports', {
    ...
    console.error('SOFTWARE-COMPANY reports API error:', error)
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    const newEntity = await heraApi.createEntity({
      organization_id,
      entity_type: 'software-company_reports',
    ...
    console.error('SOFTWARE-COMPANY reports creation error:', error)
    return NextResponse.json(
