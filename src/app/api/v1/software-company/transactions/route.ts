...
/**
 * Universal software-company management module - transactions API
...
export async function GET(request: NextRequest) {
  try {
    ...
    const entities = await heraApi.getEntities('software-company_transactions', {
    ...
    console.error('SOFTWARE-COMPANY transactions API error:', error)
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    const newEntity = await heraApi.createEntity({
      organization_id,
      entity_type: 'software-company_transactions',
    ...
    console.error('SOFTWARE-COMPANY transactions creation error:', error)
    return NextResponse.json(
