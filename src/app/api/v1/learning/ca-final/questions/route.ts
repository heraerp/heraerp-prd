  ...
  'GST_BASICS': [
    {
      ...
      difficulty: 'medium',
      question: 'What is the threshold limit for GST registration for goods suppliers in states other than special category states?',
      options: [
        'Rs. 20 lakhs',
        'Rs. 40 lakhs', 
        'Rs. 10 lakhs',
      ...
      correct_answer: 1,
      explanation: 'As per Section 22 of CGST Act, the threshold limit for GST registration for suppliers of goods in states other than special category states is Rs. 40 lakhs.',
      legal_reference: 'Section 22, CGST Act 2017',
      ai_metadata: {
        success_rate: 0.65,
        avg_time_seconds: 45,
        common_mistakes: ['Confusing with service threshold', 'Mixing special category states limit']
      }
    },
    {
      ...
      difficulty: 'hard',
      question: 'ABC Ltd. purchased machinery worth Rs. 10 lakhs (including GST @ 18%) from XYZ Ltd. on 15th March 2025. The invoice was received on 20th March 2025. Payment was made on 30th April 2025. When can ABC Ltd. claim ITC on this purchase?',
      options: [
      ...
      correct_answer: 1,
      explanation: 'As per Section 16(2) of CGST Act, ITC can be claimed only when invoice is received, goods/services are received, and payment is made to supplier within 180 days. Since payment was made in April, ITC can be claimed in April 2025.',
  ...
  'CUSTOMS_VALUATION': [
    {
      ...
      difficulty: 'medium',
      question: 'Which of the following is NOT included in transaction value for customs valuation?',
      options: [
      ...
      correct_answer: 1,
      explanation: 'Selling commission paid by exporter is not included in transaction value as it is not borne by the buyer (importer). Only buying commission is included as per Customs Valuation Rules.',
  ...
  'FTP_SCHEMES': [
    {
      ...
      correct_answer: true,
      explanation: 'As per FTP 2023, Advance Authorization can be issued for both physical exports and deemed exports like supply to EOU, SEZ units, etc.',
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (topic && questionsDatabase[topic as keyof typeof questionsDatabase]) {
      ...
      selectedQuestions = topicQuestions.filter(q => 
...
export async function POST(request: NextRequest) {
  try {
    ...
    const performanceAnalysis = {
      ...
      accuracy_rating: accuracy >= 0.8 ? 'excellent' : accuracy >= 0.6 ? 'good' : 'needs_improvement',
      ...
      next_recommended_action: accuracy < 0.6 ? 'concept_revision' : accuracy < 0.8 ? 'more_practice' : 'advance_to_mock_test'
    }
