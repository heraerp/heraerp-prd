/**
 * API v2 Leads by ID Endpoint
 * 
 * Generated by HERA Hook-Driven Module Generator  
 * RLS-scoped single leads access with organization filtering
 */
...
export async function GET(
  ...
  try {
    ...
    if (entityError || !entity) {
      return NextResponse.json(
        { 
          ...
          details: { leads_id: leadsId, organization_id: orgId }
        },
        { status: 404 }
      )
    }
    ...
    console.error('Leads by ID API error:', error)
    return NextResponse.json(
      { 
