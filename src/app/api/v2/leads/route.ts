/**
 * API v2 Leads Read Endpoint
 * 
 * Generated by HERA Hook-Driven Module Generator
 * RLS-scoped leads data access with organization filtering
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    if (entitiesError) {
      console.error('Leads query error:', entitiesError)
      return NextResponse.json(
        { 
    ...
    // Fetch dynamic fields for each leads
    ...
    const leadss = (entities || []).map(entity => {
