...
export async function POST(request: NextRequest) {
  try {
      ...
      return NextResponse.json(
        {
          ...
          demo_mode: true,
          message: 'In demo mode, external communications are disabled. Your test send was simulated but not actually sent.',
        },
        { 
    ...
    const dynamicFields = template.core_dynamic_data?.reduce((acc: any, field: any) => {
