import { BookOpen, Calendar, Users, ShoppingBag, CreditCard, Building2, TrendingUp, FileText } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 mb-12">
          <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-gray-100">Executive Summary</h2>
          <div 
        ...
        {/* Module Grid */}
        <div className="mb-12">
          <h2 className="text-3xl font-bold mb-8 text-center text-gray-800 dark:text-gray-100">Documentation Modules</h2>
        ...
        <div className="bg-gradient-to-r from-emerald-50 to-cyan-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-semibold text-lg mb-2 text-gray-800 dark:text-gray-100">Universal Architecture Benefits</h3>
            ...
            <div>
              <h3 className="font-semibold text-lg mb-2 text-gray-800 dark:text-gray-100">Salon-Specific Innovations</h3>
              <ul className="space-y-2 text-gray-500 dark:text-gray-300">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          <h2 className="text-3xl font-bold mb-6 text-gray-800 dark:text-gray-100">Implementation Timeline</h2>
          <div className="space-y-4">
            <div className="flex items-center">
              <div className="w-4 h-4 bg-emerald-600 rounded-full mr-4" />
              <div className="flex-1">
                <h3 className="font-semibold text-gray-800 dark:text-gray-100">Phase 1: Core Setup (1-4 days)</h3>
                <p className="text-gray-500 dark:text-gray-300">Organization setup, branches, services, staff</p>
              </div>
            </div>
            <div className="flex items-center">
              <div className="w-4 h-4 bg-cyan-600 rounded-full mr-4" />
              <div className="flex-1">
                <h3 className="font-semibold text-gray-800 dark:text-gray-100">Phase 2: Operations (5-8 days)</h3>
                <p className="text-gray-500 dark:text-gray-300">Client import, inventory, POS configuration</p>
              </div>
            </div>
            <div className="flex items-center">
              <div className="w-4 h-4 bg-blue-600 rounded-full mr-4" />
              <div className="flex-1">
                <h3 className="font-semibold text-gray-800 dark:text-gray-100">Phase 3: Advanced (9-14 days)</h3>
                <p className="text-gray-500 dark:text-gray-300">Financial integration, analytics, go live</p>
              </div>
            </div>
          </div>
        </div>
