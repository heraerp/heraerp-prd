...
export const metadata: Metadata = {
  ...
  description:
    'Complete workshop management system for jewelry repair and custom services with work order tracking, craftsman assignment, and quality control processes.',
  openGraph: {
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-muted-foreground mb-4">
                ...
                quality control processes, and customer communication for professional workshop
                operations.
              </p>
