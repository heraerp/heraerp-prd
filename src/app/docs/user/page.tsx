    ...
    <DocLayout navigation={navigation} docType="user" currentPath="">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4 text-hera-primary">User Guide</h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Learn how to use HERA applications effectively with step-by-step guides, tips, and best
        ...
        <div className="mb-8">
          <div className="hera-card p-6">
            ...
            <p className="text-muted-foreground mb-4">
              Start with our getting started guide to create your account, learn the basics, and get
              comfortable with the HERA interface.
            </p>
            <Button asChild className="hera-button">
              <Link href="/docs/user/getting-started">Start Here →</Link>
            </Button>
          </div>
        </div>
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-6">
          <div className="hera-card p-6">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  href="/docs/user/keyboard-shortcuts"
          ...
          <div className="hera-card p-6">
            ...
            <div className="flex gap-2">
              <Button asChild size="sm" variant="outline">
                <Link href="/docs/user/faq">View FAQ</Link>
              </Button>
