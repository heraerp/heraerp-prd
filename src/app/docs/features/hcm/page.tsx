    ...
    <div className="docs-container">
      <nav className="docs-sidebar">
        <div className="docs-nav-section">
          ...
          <a href="#payroll" className="docs-nav-link">Payroll Automation</a>
          <a href="#self-service" className="docs-nav-link">Employee Self-Service</a>
        ...
        <div className="docs-nav-section">
          ...
          <Link href="/docs/features/time-tracking" className="docs-nav-link">Time & Attendance</Link>
          <Link href="/docs/features/benefits" className="docs-nav-link">Benefits Administration</Link>
        </div>
      </nav>
      ...
      <main className="docs-main">
        <div className="mb-8">
          ...
          <p className="text-xl text-muted-foreground mt-2">
            Complete workforce management from hiring to retirement with automated payroll and self-service
          </p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm mt-1">
                Managing 50,000+ employees globally with 90% payroll automation and 2-hour processing time.
                Trusted by enterprises for mission-critical HR operations.
              </p>
            </div>
          </div>
        </div>
        ...
        <section id="overview" className="mb-12">
          <h2>Overview</h2>
          <p>
            HERA HCM revolutionizes human resources management with intelligent automation, employee self-service, 
            and real-time analytics. From recruitment to retirement, every aspect of the employee lifecycle is 
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-3">
                    Manage every stage from recruitment to retirement with automated workflows and compliance tracking.
                  </p>
            ...
            <div className="docs-card">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-3">
                    Smart time tracking with geo-fencing, shift management, and automatic overtime calculations.
                  </p>
            ...
            <div className="docs-card">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-3">
                    Comprehensive benefits management with enrollment workflows and real-time eligibility tracking.
                  </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Automatic sync from time systems</p>
                    </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Process earnings and deductions</p>
                    </div>
                    <span className="ml-auto text-xs bg-canvas-inset px-2 py-1 rounded">15 min</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-4 h-4 bg-accent-emphasis rounded-full"></div>
                    <div>
                      <p className="font-medium">Review & Approval</p>
                      <p className="text-sm text-muted-foreground">Exception handling and validation</p>
                    </div>
                    <span className="ml-auto text-xs bg-canvas-inset px-2 py-1 rounded">30 min</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-4 h-4 bg-accent-emphasis rounded-full"></div>
                    <div>
                      <p className="font-medium">Bank File Generation</p>
                      <p className="text-sm text-muted-foreground">Create payment files and GL posting</p>
                    </div>
                    <span className="ml-auto text-xs bg-canvas-inset px-2 py-1 rounded">10 min</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link href="/docs/features/performance" className="docs-card hover:border-accent-fg transition-colors">
            ...
            <Link href="/docs/features/learning" className="docs-card hover:border-accent-fg transition-colors">
              <div className="flex items-center justify-between">
                <div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm mt-1">
                  ...
                  <Link href="/contact" className="underline">Contact us</Link> to see how we can transform your workforce management.
                </p>
              </div>
            </div>
          </div>
