    ...
    <div className="docs-container">
      <nav className="docs-sidebar">
        <div className="docs-nav-section">
          ...
          <a href="#workflow" className="docs-nav-link">
            Purchase Workflow
          </a>
          <a href="#automation" className="docs-nav-link">
            Automation
          </a>
        ...
        <div className="docs-nav-section">
          ...
          <Link href="/docs/features/vendor-portal" className="docs-nav-link">
            Vendor Portal
          </Link>
          <Link href="/docs/features/approvals" className="docs-nav-link">
            Approval Workflows
          </Link>
        </div>
      </nav>
      ...
      <main className="docs-main">
        <div className="mb-8">
          ...
          <p className="text-xl text-muted-foreground mt-2">
            Streamline your entire purchasing process from requisition to payment with intelligent
            automation
          </p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm mt-1">
                Processing over 10,000+ purchase orders monthly with 75% faster cycle times and
                $340K average annual savings.
              </p>
            </div>
          </div>
        </div>
        ...
        <section id="overview" className="mb-12">
          <h2>Overview</h2>
          <p>
            HERA P2P transforms your procurement operations with end-to-end automation, intelligent
            approvals, and real-time visibility. From purchase requisitions to vendor payments,
            every step is optimized for speed, accuracy, and control.
          </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-3">
                    Create requisitions in seconds with intelligent item suggestions, budget
                    checking, and automatic routing.
                  </p>
            ...
            <div className="docs-card">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-3">
                    Convert approved requisitions to POs instantly with vendor selection, price
                    negotiation, and terms management.
                  </p>
...
Total time: < 2 minutes`}
            ...
            <div className="docs-card">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-3">
                    Automatically match POs, receipts, and invoices. Process payments with full
                    audit trail and GL posting.
                  </p>
        ...
        <section id="workflow" className="mb-12">
          ...
          <div className="docs-note docs-note-info mb-6">
            <strong>End-to-End Automation:</strong> Every step from requisition to payment is
            automated, reducing manual work by 85% while improving accuracy and control.
          </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Users submit purchase requests with automatic budget validation and approval
                    routing
                  </p>
                </div>
            ...
            <div className="docs-card">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Multi-level approvals based on amount, category, and department with mobile
                    notifications
                  </p>
                </div>
                <span className="text-xs bg-success-subtle text-success-fg px-2 py-1 rounded">
        ...
        <section id="automation" className="mb-12">
          ...
          <div className="grid gap-6">
            <div className="docs-card">
              ...
              <p className="text-muted-foreground mb-3">
                Dynamic approval routing based on purchase amount, category, and organizational
                hierarchy:
              </p>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link
              href="/docs/features/vendor-portal"
