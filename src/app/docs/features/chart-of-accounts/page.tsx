    ...
    <div className="docs-container">
      <nav className="docs-sidebar">
        <div className="docs-nav-section">
          ...
          <a href="#ifrs-compliance" className="docs-nav-link">
            IFRS Compliance
          </a>
          <a href="#templates" className="docs-nav-link">
            Industry Templates
          </a>
      ...
      <main className="docs-main">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm mt-1">
                132 template combinations covering 12 countries × 11 industries with complete IFRS
                compliance. Used in production by businesses worldwide.
              </p>
            </div>
          </div>
        </div>
        ...
        <section id="overview" className="mb-12">
          <h2>Overview</h2>
          <p>
            HERA's Universal Chart of Accounts revolutionizes financial account management by
            providing enterprise-grade accounting structures that set up in 30 seconds instead of 18
            months. Every COA is automatically IFRS-compliant with complete lineage tracking.
          </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-3">
                    Pre-configured templates for 12 countries × 11 industries, each with complete
            ...
            <div className="docs-card">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-3">
                    GL accounts stored as entities with dynamic properties - no schema changes ever
                    needed:
                  </p>
                  <pre className="text-xs bg-canvas-inset p-3 rounded overflow-x-auto">
  ...
  smart_code: 'HERA.FIN.GL.PROP.TYPE.V1'
        ...
        <section id="ifrs-compliance" className="mb-12">
          ...
          <div className="docs-note docs-note-info mb-6">
            <strong>Revolutionary Achievement:</strong> HERA is the first ERP system with built-in
            IFRS compliance by default. Every Chart of Accounts generated includes complete IFRS
          ...
          <table className="w-full">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <code>ifrs_sub_classification</code>
                </td>
...
await universalApi.setDynamicField(accountId, 'ifrs_line_item', 'Marketing expenses')`}
              </pre>
            </div>
  ...
  smart_code: 'HERA.FIN.GL.HIERARCHY.v1'
        ...
        <section id="examples" className="mb-12">
          ...
          <div className="grid gap-6">
            <div className="docs-card">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <code>1000</code> - Cash - Operating Account
                </li>
                <li>
                  <code>1300</code> - Inventory - Food & Beverages
                </li>
                <li>
                  <code>2201</code> - VAT Payable (5%)
                </li>
                <li>
                  <code>4100</code> - Revenue - Food Sales
                </li>
                <li>
                  <code>5100</code> - COGS - Food Ingredients
                </li>
                <li>
                  <code>6000</code> - Salaries - Kitchen Staff
                </li>
              </ul>
            </div>
            ...
            <div className="docs-card">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <code>1200</code> - Patient Receivables
                </li>
                <li>
                  <code>1250</code> - Insurance Receivables
                </li>
                <li>
                  <code>4200</code> - Revenue - Consultations
                </li>
                <li>
                  <code>4300</code> - Revenue - Procedures
                </li>
                <li>
                  <code>5200</code> - Medical Supplies
                </li>
                <li>
                  <code>6100</code> - Professional Fees
                </li>
              </ul>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Link
              href="/docs/api/rest#chart-of-accounts"
              className="docs-card hover:border-accent-fg transition-colors"
            >
              <div className="flex items-center justify-between">
                <div>
