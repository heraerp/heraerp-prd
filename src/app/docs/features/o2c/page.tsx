    ...
    <div className="docs-container">
      <nav className="docs-sidebar">
        <div className="docs-nav-section">
          ...
          <a href="#order-management" className="docs-nav-link">Order Management</a>
          <a href="#invoicing" className="docs-nav-link">Automated Invoicing</a>
          <a href="#collections" className="docs-nav-link">Smart Collections</a>
        ...
        <div className="docs-nav-section">
          ...
          <Link href="/docs/features/customer-portal" className="docs-nav-link">Customer Portal</Link>
          <Link href="/docs/features/credit-management" className="docs-nav-link">Credit Management</Link>
        </div>
      </nav>
      ...
      <main className="docs-main">
        <div className="mb-8">
          ...
          <p className="text-xl text-muted-foreground mt-2">
            Accelerate your revenue cycle from order capture to cash collection with intelligent automation
          </p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm mt-1">
                Processing $500M+ in annual transactions with 65% faster collections and 92% invoice accuracy.
                Proven across B2B and B2C industries.
              </p>
            </div>
          </div>
        </div>
        ...
        <section id="overview" className="mb-12">
          <h2>Overview</h2>
          <p>
            HERA O2C transforms your revenue operations with automated order processing, intelligent invoicing, 
            and proactive collections management. Every step from quote to cash is optimized for speed, 
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-3">
                    Capture orders from any channel with automatic validation, pricing, and inventory allocation.
                  </p>
            ...
            <div className="docs-card">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-3">
                    Generate and deliver invoices instantly with customizable templates and automatic GL posting.
                  </p>
...
Total time: < 5 minutes`}</pre>
            ...
            <div className="docs-card">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-3">
                    AI-powered collections with automated reminders, payment plans, and risk scoring.
                  </p>
        ...
        <section id="order-management" className="mb-12">
          ...
          <div className="docs-note docs-note-info mb-6">
            <strong>Omnichannel Order Capture:</strong> Accept orders from web, mobile, EDI, email, or phone 
            with automatic consolidation and intelligent routing.
          </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">Credit check, inventory availability, pricing rules</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">Warehouse allocation, shipping optimization, tracking</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">Automatic invoicing based on delivery confirmation</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link href="/docs/features/customer-portal" className="docs-card hover:border-accent-fg transition-colors">
            ...
            <Link href="/docs/features/revenue-analytics" className="docs-card hover:border-accent-fg transition-colors">
              <div className="flex items-center justify-between">
                <div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm mt-1">
                  ...
                  <Link href="/contact" className="underline">Contact us</Link> to see how we can transform your revenue cycle.
                </p>
              </div>
            </div>
          </div>
