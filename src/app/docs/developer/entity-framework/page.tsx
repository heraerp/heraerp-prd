    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        ...
        <section className="text-center py-16">
          <h1 className="text-5xl font-bold text-white mb-6">Universal Entity Framework</h1>
          <p className="text-xl text-blue-200 max-w-4xl mx-auto mb-8">
            Revolutionary preset-driven entity management system that transforms 500+ lines of
            custom CRUD code into 12 lines of configuration. Built on HERA's Sacred Six tables with
            complete type safety, role-based permissions, and automatic diagram generation.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 p-6">
              ...
              <p className="text-blue-200 mb-4">
                Configuration-driven entity definitions with dynamic fields, relationships, and
                permissions.
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 p-6">
              ...
              <p className="text-blue-200 mb-4">
                Single API endpoint handles all entity operations with automatic validation and
                relationships.
              </p>
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              {
                name: 'PRODUCT',
                fields: '7 fields, 3 rels',
                description: 'Physical items with pricing & inventory'
              },
              {
                name: 'SERVICE',
                fields: '5 fields, 3 rels',
                description: 'Salon treatments with duration & commission'
              },
              {
                name: 'CUSTOMER',
                fields: '7 fields, 2 rels',
                description: 'Customer profiles with loyalty tracking'
              },
              {
                name: 'EMPLOYEE',
                fields: '6 fields, 3 rels',
                description: 'Staff with roles & capabilities'
              },
              {
                name: 'APPOINTMENT',
                fields: '5 fields, 3 rels',
                description: 'Scheduling with customer/service links'
              },
              {
                name: 'VENDOR',
                fields: '6 fields, 1 rels',
                description: 'Suppliers with payment terms'
              },
              {
                name: 'CATEGORY',
                fields: '4 fields, 1 rels',
                description: 'Hierarchical organization system'
              },
              {
                name: 'BRAND',
                fields: '3 fields, 1 rels',
                description: 'Product manufacturers & providers'
              },
              {
                name: 'ROLE',
                fields: '3 fields, 0 rels',
                description: 'Permission sets & capabilities'
              }
            ].map((entity, index) => (
        ...
        <section className="mb-16">
          ...
          <div className="bg-black/30 rounded-xl border border-white/20 p-6 mb-8">
            ...
            <div className="bg-black/50 rounded-lg p-4 text-sm font-mono overflow-x-auto">
              ...
              <div className="mt-4 text-purple-400">export default function</div>{' '}
              <div className="text-yellow-400">ProductsUniversalPage</div>
              <div className="text-white">() {'{'}</div>
              <div className="pl-2 text-gray-400">
                const {"{ userRole = 'staff' }"} = <div className="text-blue-400">useHERAAuth</div>
                () ?? {'{}'}
              </div>
              <div className="mt-2 pl-2 text-purple-400">return</div>{' '}
              <div className="text-white">(</div>
              ...
              <div className="pl-6 text-green-400">
                title=<div className="text-orange-400">"Product Management"</div>
              </div>
              <div className="pl-6 text-green-400">
                subtitle=
                <div className="text-orange-400">"Manage your salon\'s product inventory"</div>
              </div>
          ...
          <div className="bg-black/30 rounded-xl border border-white/20 p-6">
            ...
            <div className="bg-black/50 rounded-lg p-4 text-sm font-mono overflow-x-auto">
              ...
              <div className="text-yellow-400">PRODUCT_PRESET</div>{' '}
              <div className="text-white">= {'{'}</div>
              <div className="pl-2 text-green-400">
                entity_type: <div className="text-orange-400">'PRODUCT'</div>,
              </div>
              <div className="pl-2 text-green-400">labels: {'{'}</div>
              <div className="pl-4 text-green-400">
                singular: <div className="text-orange-400">'Product'</div>,
              </div>
              <div className="pl-4 text-green-400">
                plural: <div className="text-orange-400">'Products'</div>
              </div>
              <div className="pl-2 text-white">{'},'}</div>
              ...
              <div className="pl-4 text-green-400">
                ...
                <div className="text-blue-400">
                  (role: Role) {'=>'} ['owner', 'manager'].includes(role)
                </div>
                ,
              </div>
              <div className="pl-4 text-green-400">
                edit:{' '}
                <div className="text-blue-400">
                  (role: Role) {'=>'} ['owner', 'manager', 'receptionist'].includes(role)
                </div>
                ,
              </div>
              <div className="pl-4 text-green-400">
              ...
              <div className="pl-4 text-green-400">
                view: <div className="text-blue-400">() {'=>'} true</div>
              </div>
              <div className="pl-2 text-white">{'},'}</div>
              <div className="pl-2 text-green-400">dynamicFields: [</div>
              <div className="pl-4 text-white">{'{'}</div>
              <div className="pl-6 text-green-400">
                name: <div className="text-orange-400">'price_market'</div>,
              </div>
              <div className="pl-6 text-green-400">
                type: <div className="text-orange-400">'number'</div>,
              </div>
              <div className="pl-6 text-green-400">
                smart_code:{' '}
              ...
              <div className="pl-4 text-white">{'{'}</div>
              <div className="pl-6 text-green-400">
                type: <div className="text-orange-400">'HAS_CATEGORY'</div>,
              </div>
              <div className="pl-6 text-green-400">
                smart_code:{' '}
        ...
        <section className="mb-16">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 p-6">
            ...
            <p className="text-blue-200 mb-6">
              The framework automatically generates comprehensive Mermaid diagrams showing entity
              structures, relationships, and the complete system architecture. These diagrams update
              automatically when your presets change, ensuring documentation is always current.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">
                    Transform 500+ lines of custom CRUD code into 12 lines of configuration
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">
                    Complete TypeScript integration with auto-generated types
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">
                    Granular access control at field and operation level
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">
                    Built on HERA's Sacred Six tables with zero schema changes
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">
                    Self-updating visual diagrams and comprehensive documentation
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">
                    Automatic business intelligence and relationship detection
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="text-center py-8 border-t border-white/10">
          <p className="text-blue-200 mb-4">
            The Universal Entity Framework proves that HERA's revolutionary architecture can
            eliminate enterprise software complexity while maintaining complete functionality and
            type safety.
          </p>
          <Link
            href="/docs/developer"
