...
export const metadata = {
  ...
  description:
    'Master case management in Civicflow. Complete guide for tracking service requests, complaints, and citizen issues from intake to resolution.',
  keywords:
    'Civicflow case management, service requests, complaint tracking, issue resolution, public sector case system'
}
