...
export const metadata = {
  ...
  description:
    'Learn how to manage constituents in Civicflow CRM. Complete guide for tracking citizens, stakeholders, and community members in your public sector organization.',
  keywords:
    'Civicflow CRM, constituent management, citizen tracking, public sector CRM, stakeholder management'
}
