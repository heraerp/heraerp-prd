...
export const metadata = {
  ...
  description: 'Master multi-channel communications in Civicflow. Complete guide for email campaigns, SMS messaging, emergency alerts, and constituent engagement.',
  keywords: 'Civicflow communications, email campaigns, SMS messaging, emergency alerts, constituent outreach, public sector communications',
}
