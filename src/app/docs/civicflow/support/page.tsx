...
export const metadata = {
  ...
  description: 'Get help with Civicflow. Access support resources, training programs, troubleshooting guides, and contact information for comprehensive assistance.',
  keywords: 'Civicflow support, help center, training, troubleshooting, customer support, technical assistance',
}
