...
export default function PricingRequestPage() {
      ...
      <main className="mx-auto my-16 w-[92%] max-w-3xl">
        <div className="rounded-3xl bg-card border border-border shadow-xl p-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-300">
            Our team will review your requirements and send a custom quote. You can speed things up
            by booking a quick discovery call.
          </p>
          <div className="mt-6 flex gap-2">
            <a
              href="/book-a-meeting"
              className="inline-flex items-center justify-center rounded-xl bg-gradient-to-br from-indigo-600 via-fuchsia-600 to-cyan-500 text-white px-4 py-2 text-sm font-medium shadow hover:opacity-95 transition"
            >
              Book a Discovery Call
            </a>
            <a
              href="/"
              className="inline-flex items-center justify-center rounded-xl border border-border bg-secondary px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-secondary/80 transition"
            >
              Back to Home
            </a>
          </div>
  ...
  return (
    <>
      <main className="mx-auto my-16 w-[92%] max-w-3xl">
        <div
          className="mx-auto mb-6 h-20 w-full max-w-3xl bg-gradient-to-r from-indigo-500/20 via-fuchsia-400/15 to-cyan-400/20 blur-2xl rounded-3xl"
          aria-hidden="true"
        />
        <div className="rounded-3xl bg-card border border-border shadow-xl p-6 md:p-8">
          ...
          <p className="mt-2 ink-muted">
            On average, HERA ERP delivers the same or better capability at roughly one-third the
            cost of SAP/Oracle, with faster implementation and 70% AI-driven automation. Tell us
            about your business and we'll tailor a proposal.
          </p>
          ...
          <form onSubmit={handleSubmit} className="mt-6 grid grid-cols-1 gap-4">
            ...
            <SelectField
              ...
              placeholder="Select band (optional)"
            />
            <TextField
              name="currentErp"
              label="Current ERP (optional)"
              placeholder="SAP, Oracle, NetSuite, spreadsheets…"
            />
            <SelectField
              name="timeline"
            ...
            <SelectField
              name="erpModules"
              label="Required ERP Modules"
              options={erpModules}
              error={errors.erpModules}
              required
            />
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Briefly describe your key goals, challenges, or integrations you care about."
              />
            </div>
...
function TextField({
  ...
  return (
    <div>
      <label htmlFor={name} className="text-sm text-gray-900 dark:text-white">
        {label}
        {required ? ' *' : ''}
      </label>
      <input
...
function SelectField({
  ...
  return (
    <div>
      <label htmlFor={name} className="text-sm ink">
        {label}
        {required ? ' *' : ''}
      </label>
      <select
