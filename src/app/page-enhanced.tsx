...
export default function EnhancedLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <Link href="/" className="flex items-center gap-3">
                ...
                <span className="text-xl font-semibold text-gray-900 dark:text-gray-100">HERA</span>
              </Link>
            </div>
              ...
              <div key={stage.stage} className="relative">
                <div className="text-center">
                  <div className="inline-flex p-4 bg-blue-100 dark:bg-blue-900/30 rounded-2xl mb-4">
                    <stage.icon className="w-8 h-8 text-blue-600 dark:text-blue-400" />
                  </div>
                ...
                {index < journeyStages.length - 1 && (
                  <div className="hidden md:block absolute top-16 left-full w-full">
                    <ArrowRight className="w-6 h-6 text-gray-300 dark:text-gray-600 mx-auto" />
                  </div>
                )}
              </div>
            ))}
      ...
      {/* Industry Showcase */}
      <section id="discover" className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            {[
              ...
              <Card key={item.name} className="p-6 text-center min-w-[200px]">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{item.coming}</p>
              </Card>
            ))}
          </div>
        </div>
