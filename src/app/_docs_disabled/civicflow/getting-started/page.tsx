...
export const metadata = {
  ...
  description:
    'Learn how to get started with Civicflow CRM and grants management platform. Complete setup guide for new users and administrators.',
  keywords:
    'Civicflow getting started, CRM setup, public sector software setup, grants management setup'
}
