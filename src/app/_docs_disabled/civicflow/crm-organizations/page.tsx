...
export const metadata = {
  ...
  description:
    'Comprehensive guide to managing organizations in Civicflow CRM. Learn how to track businesses, non-profits, government agencies, and other entities.',
  keywords:
    'Civicflow organizations, business management, CRM organizations, entity tracking, public sector CRM'
}
