          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-gray-500 dark:text-gray-300">
                The service catalog allows you to define and manage all salon services with flexible
                pricing, duration settings, and staff assignments. Services can be customized per
                branch with specific pricing and availability.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg p-4">
                <p className="text-emerald-800 dark:text-emerald-200">
                  Complete service catalog documentation is being prepared. This will include setup
                  guides, pricing strategies, and best practices.
                </p>
              </div>
            </section>
          </div>
