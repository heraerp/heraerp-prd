...
export const metadata: Metadata = {
  ...
  description:
    'Comprehensive inventory management for jewelry retailers. Track diamonds, gemstones, precious metals, and finished jewelry with complete specifications and valuations.',
  openGraph: {
    title: 'Inventory Management - HERA Jewelry ERP',
    description:
      'Track diamonds, gemstones, precious metals, and finished jewelry with complete specifications',
    type: 'article'
  }
}
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-muted-foreground mb-4">
                Learn how to track diamonds, gemstones, precious metals, and finished jewelry with
                complete specifications, certifications, and real-time valuations designed
                specifically for jewelry retail.
              </p>
