...
export default function SalonModernDashboard() {
  ...
  const [selectedTab, setSelectedTab] = useState<'dashboard' | 'calendar' | 'services' | 'team' | 'whatsapp'>('dashboard')
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-pink-50/30 to-purple-50/30 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900">
          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="flex flex-wrap gap-3 justify-center sm:justify-start">
              <Button 
                ...
                className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white shadow-md hover:shadow-lg transform hover:scale-105 transition-all"
              >
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between">
                          <div>
                            ...
                            <p className="text-sm !text-gray-700 dark:!text-gray-300 font-medium">{member.title}</p>
                          </div>
                          <Badge
                        ...
                        <div className="flex items-center gap-3 mt-3">
                          ...
                          <span className="text-sm !text-gray-600 dark:!text-gray-400">({member.reviews} reviews)</span>
                          <a
      ...
      <button 
        onClick={() => setIsBookingOpen(true)}
        className="md:hidden fixed bottom-6 right-6 w-14 h-14 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full shadow-2xl flex items-center justify-center text-white transform hover:scale-110 transition-all"
      >
