...
export default function ProductListPage() {
  ...
  const [entities, setEntities] = useState<ProductData[]>([])
  ...
  const handleEdit = (entityId: string) => {
    window.location.href = `/product/${entityId}/edit`
  }

  const handleView = (entityId: string) => {
    window.location.href = `/product/${entityId}`
  }
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Product master for rebate eligibility</p>
                </div>
              </div>
        ...
        <div className="p-6">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle>
                  {filteredEntities.length} Product{filteredEntities.length !== 1 ? 's' : ''}
                </CardTitle>
                    ...
                    <tbody>
                      {filteredEntities.map((entity) => (
                        <tr key={entity.id} className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4">
                            <span className="font-mono text-sm">{entity.entity_code || 'N/A'}</span>
                          </td>
                          <td className="py-3 px-4">
