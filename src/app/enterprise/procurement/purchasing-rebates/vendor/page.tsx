...
export default function VendorListPage() {
  ...
  const [entities, setEntities] = useState<VendorData[]>([])
  ...
  const handleCreate = () => {
    window.location.href = `/enterprise/procurement/purchasing-rebates/vendor/new`
  }

  const handleEdit = (entityId: string) => {
    window.location.href = `/enterprise/procurement/purchasing-rebates/vendor/${entityId}/edit`
  }

  const handleView = (entityId: string) => {
    window.location.href = `/enterprise/procurement/purchasing-rebates/vendor/${entityId}`
  }
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Supplier vendor master data</p>
                </div>
              </div>
        ...
        <div className="p-6">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle>
                  {filteredEntities.length} Vendor{filteredEntities.length !== 1 ? 's' : ''}
                </CardTitle>
