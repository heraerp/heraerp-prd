...
const HERAGOODSRECEIPTApp = () => {
  const router = useRouter()
  const { user, organization, isAuthenticated } = useHERAAuth()
  
  const [activeTab, setActiveTab] = useState('header')
  const [transactionType, setTransactionType] = useState('GOODS_RECEIPT')
  ...
  const [headerData, setHeaderData] = useState({
    ...
    condition: 'Good',
    notes: '',
    smart_code: 'HERA.PROCUREMENT.TXN.GOODS_RECEIPT.v1',
    status: 'draft',
    total_amount: 0.00
  })
  ...
  const [lines, setLines] = useState([
    { 
      ...
      product_code: '',
      description: '',
      ordered_qty: 0, // Default quantity to 1
      received_qty: 0, // Default quantity to 1
      rejected_qty: 0, // Default quantity to 1
      batch_lot: '',
      line_amount: 0.00,
      editing: false 
    }
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      console.log('Goods Receipt transaction data:', { transactionData, transactionLines })
      ...
      */
      ...
      showToast(`Goods Receipt "${headerData.gr_number}" created successfully! Redirecting...`, 'success')
      ...
      showToast('Failed to create goods receipt. Please try again.', 'error')
    } finally {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">Please log in to access goods receipt management.</p>
        </div>
      </div>
    )
  }
          ...
          <div className="lg:col-span-6">
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl border border-gray-200/50 shadow-xl">
              ...
              <div className="p-6 border-b border-gray-200/50">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Record receipt of goods and materials</p>
                  </div>
                </div>
              ...
              <div className="p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          type="text"
                          value={headerData.gr_number}
                          onChange={(e) => updateHeaderData('gr_number', e.target.value)}
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => updateHeaderData('po_number', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          required
                        >
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => updateHeaderData('vendor_id', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          required
                        >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateHeaderData('receipt_date', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          placeholder=""
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          value={headerData.delivery_note}
                          onChange={(e) => updateHeaderData('delivery_note', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      ...
                      <div>
                        ...
                        <select
                          value={headerData.received_by}
                          onChange={(e) => updateHeaderData('received_by', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          required
                        >
                      ...
                      <div>
                        ...
                        <select
                          value={headerData.warehouse_location}
                          onChange={(e) => updateHeaderData('warehouse_location', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          required
                        >
                      ...
                      <div>
                        ...
                        <select
                          value={headerData.condition}
                          onChange={(e) => updateHeaderData('condition', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          required
                        >
                          <option value="">Select goods condition</option>
                        ...
                        <div key={line.id} className="bg-gray-50 rounded-lg p-4 border">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                              ...
                              <input
                                type="text"
                                value={line.po_line_ref}
                                onChange={(e) => updateLineData(line.id, 'po_line_ref', e.target.value)}
                            ...
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => updateLineData(line.id, 'ordered_qty', Number(e.target.value))}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                                placeholder=""
                                readOnly
                              />
                            ...
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => updateLineData(line.id, 'received_qty', Number(e.target.value))}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                                placeholder="0"
                            ...
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => updateLineData(line.id, 'rejected_qty', Number(e.target.value))}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                                placeholder="0"
                            ...
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => updateLineData(line.id, 'batch_lot', e.target.value)}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                ...
                {activeTab === 'preview' && (
                  <div className="space-y-6">
                    <h2 className="text-lg font-semibold text-gray-900">Goods Receipt Preview</h2>
                    
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h3 className="font-medium text-gray-900 mb-3">Receipt Summary</h3>
                      <div className="text-sm text-gray-600">
                        Preview content for receipt summary will be displayed here.
                      </div>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h3 className="font-medium text-gray-900 mb-3">PO Reference</h3>
                      <div className="text-sm text-gray-600">
                        Preview content for po reference will be displayed here.
                      </div>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h3 className="font-medium text-gray-900 mb-3">Received Items</h3>
                      <div className="text-sm text-gray-600">
                        Preview content for received items will be displayed here.
                      </div>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h3 className="font-medium text-gray-900 mb-3">Quality Notes</h3>
                      <div className="text-sm text-gray-600">
                        Preview content for quality notes will be displayed here.
                      </div>
                    </div>
                  </div>
                )}
          ...
          <div className="hidden lg:block lg:col-span-3">
            <div className="sticky top-6">
              <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 border border-gray-200/50 shadow-xl">
                ...
                <div className="space-y-4">
                  <div className="text-sm text-gray-600">
                    I can help you with goods receipt processing and inventory management. Ask me about:
                  </div>
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <textarea
                      placeholder="Ask me anything about this goods receipt..."
...
export default HERAGOODSRECEIPTApp