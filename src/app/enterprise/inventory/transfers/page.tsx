...
import { 
  ...
  Filter, RefreshCw, Lock, Unlock, AlertTriangle, Info, ArrowRightLeft
} from 'lucide-react'
...
const HERAINVENTORYTRANSFERApp = () => {
  const router = useRouter()
  const { user, organization, isAuthenticated } = useHERAAuth()
  
  const [activeTab, setActiveTab] = useState('header')
  const [transactionType, setTransactionType] = useState('INVENTORY_TRANSFER')
  ...
  const [headerData, setHeaderData] = useState({
    ...
    reason: '',
    notes: '',
    smart_code: 'HERA.INVENTORY.TXN.INVENTORY_TRANSFER.v1',
    status: 'draft',
    total_amount: 0.00
  })
  ...
  const [lines, setLines] = useState([
    { 
      ...
      product_code: '',
      description: '',
      current_stock: 1, // Default quantity to 1
      transfer_qty: 0, // Default quantity to 1
      batch_lot: '',
  ...
  const handleSubmit = useCallback(async () => {
    ...
    showToast('Creating inventory transfer...', 'info')

    try {
      // Prepare transaction data for HERA API v2
      const transactionData = {
        transaction_type: 'inventory_transfer',
        transaction_code: headerData.transfer_number,
        ...
        transaction_date: headerData.transfer_date,
      ...
      console.log('Inventory Transfer transaction data:', { transactionData, transactionLines })
      ...
      */
      ...
      showToast(`Inventory Transfer "${headerData.transfer_number}" created successfully! Redirecting...`, 'success')
      
      setTimeout(() => {
        router.push('/enterprise/inventory')
      }, 2000)
      
    } catch (error) {
      console.error('Submit error:', error)
      showToast('Failed to create inventory transfer. Please try again.', 'error')
    } finally {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">Please log in to access inventory transfer management.</p>
        </div>
      </div>
    )
  }
      ...
      <div className="md:hidden sticky top-0 z-50 bg-white/90 backdrop-blur-xl border-b border-gray-200/50">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-gray-900">Inventory Transfer</h1>
              <p className="text-xs text-gray-600">HERA INVENTORY</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-6">
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl border border-gray-200/50 shadow-xl">
              ...
              <div className="p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          type="text"
                          value={headerData.transfer_number}
                          onChange={(e) => updateHeaderData('transfer_number', e.target.value)}
                      ...
                      <div>
                        ...
                        <select
                          value={headerData.from_location}
                          onChange={(e) => updateHeaderData('from_location', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          required
                        >
                      ...
                      <div>
                        ...
                        <select
                          value={headerData.to_location}
                          onChange={(e) => updateHeaderData('to_location', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          required
                        >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateHeaderData('transfer_date', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          placeholder=""
                      ...
                      <div>
                        ...
                        <select
                          value={headerData.requested_by}
                          onChange={(e) => updateHeaderData('requested_by', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          required
                        >
                      ...
                      <div>
                        ...
                        <select
                          value={headerData.transfer_type}
                          onChange={(e) => updateHeaderData('transfer_type', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          required
                        >
                      ...
                      <div className="md:col-span-2">
                        ...
                        <textarea
                          ...
                          onChange={(e) => updateHeaderData('reason', e.target.value)}
                          rows={3}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => updateLineData(line.id, 'current_stock', Number(e.target.value))}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                                placeholder=""
                                readOnly
                              />
                            ...
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => updateLineData(line.id, 'transfer_qty', Number(e.target.value))}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                                placeholder="0"
                            ...
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => updateLineData(line.id, 'expiry_date', e.target.value)}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                                placeholder=""
                ...
                {activeTab === 'preview' && (
                  <div className="space-y-6">
                    <h2 className="text-lg font-semibold text-gray-900">Inventory Transfer Preview</h2>
                    
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h3 className="font-medium text-gray-900 mb-3">Transfer Summary</h3>
                      <div className="text-sm text-gray-600">
                        Preview content for transfer summary will be displayed here.
                      </div>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h3 className="font-medium text-gray-900 mb-3">Location Details</h3>
                      <div className="text-sm text-gray-600">
                        Preview content for location details will be displayed here.
                      </div>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h3 className="font-medium text-gray-900 mb-3">Items to Transfer</h3>
                      <div className="text-sm text-gray-600">
                        Preview content for items to transfer will be displayed here.
                      </div>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h3 className="font-medium text-gray-900 mb-3">Stock Impact</h3>
                      <div className="text-sm text-gray-600">
                        Preview content for stock impact will be displayed here.
                      </div>
                    </div>
                  </div>
                )}
          ...
          <div className="hidden lg:block lg:col-span-3">
            <div className="sticky top-6">
              <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 border border-gray-200/50 shadow-xl">
                ...
                <div className="space-y-4">
                  <div className="text-sm text-gray-600">
                    I can help you with inventory transfer processing and warehouse management. Ask me about:
                  </div>
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <textarea
                      placeholder="Ask me anything about this inventory transfer..."
...
export default HERAINVENTORYTRANSFERApp