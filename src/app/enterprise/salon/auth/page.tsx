...
export default function SalonAuthPage() {
  ...
  useEffect(() => {
    // Redirect to enterprise salon home for enterprise authentication experience
    console.log('🔀 Redirecting /enterprise/salon/auth → /enterprise/salon/home for enterprise authentication')
    router.replace('/enterprise/salon/home')
  }, [router])
