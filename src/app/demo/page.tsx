    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Checking current session...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-background py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-foregroundmb-4">
            HERA Demo Gallery
          </h1>
        ...
        {showLogoutConfirm && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-card rounded-lg p-6 max-w-md w-full mx-4">
              <h3 className="text-lg font-semibold text-foregroundmb-4">Confirm Logout</h3>
              ...
              <div className="flex space-x-4">
                ...
                <button
                  ...
                  className="flex-1 bg-muted hover:bg-muted/80 text-foregroundpx-4 py-2 rounded-md transition-colors"
                >
                  Cancel
                </button>
              </div>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {demo.available ? (
                    ...
                    <div className="text-center py-2 px-4 rounded-md bg-muted/50 text-muted-foreground">
                      Coming Soon
                    </div>
                  )}
                </div>
