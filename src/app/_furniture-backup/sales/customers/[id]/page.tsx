    ...
    <div className="space-y-6">
          ...
          {!editMode ? (
            ...
            <div className="bg-[var(--color-body)] flex items-center gap-2">
              ...
              <button
                ...
                className="inline-flex items-center px-4 py-2 border border-[var(--color-border)] border-[var(--color-border)] text-sm font-medium rounded-md text-[var(--color-text-primary)] dark:text-[var(--color-text-primary)] bg-[var(--color-body)] bg-muted-foreground/10 hover:bg-[var(--color-body)] dark:hover:bg-[var(--color-body)]"
              >
                {' '}
                <X className="bg-[var(--color-body)] h-4 w-4 mr-2" /> Cancel{' '}
              </button>{' '}
              <button
                onClick={handleSave}
                disabled={loading}
              ...
              >
                ...
                {loading ? (
                  <>
                    {' '}
                    <div className="bg-[var(--color-body)] animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2"></div>{' '}
                    Saving...{' '}
                  </>
                ) : (
                  <>
      ...
      {error && (
        <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-md p-4">
          {' '}
          <div className="bg-[var(--color-body)] flex">
            {' '}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {' '}
        <div className="bg-[var(--color-body)] overflow-hidden shadow rounded-lg">
          {' '}
          <div className="p-5">
            {' '}
            <div className="flex items-center">
              {' '}
              <div className="flex-shrink-0 bg-[var(--color-body)] rounded-md p-3">
                {' '}
                <Package className="h-6 w-6 text-[var(--color-icon-secondary)]" />{' '}
              </div>{' '}
              <div className="ml-5 w-0 flex-1">
                {' '}
                <dl>
                  {' '}
                  <dt className="bg-[var(--color-body)] text-sm font-medium text-[var(--color-text-secondary)] dark:text-[var(--color-text-secondary)] truncate">
                    {' '}
                    Total Orders{' '}
                  </dt>{' '}
                  <dd className="bg-[var(--color-body)] text-2xl font-semibold text-[var(--color-text-primary)] text-[var(--color-text-primary)]">
                    {' '}
                    {metrics.orderCount}{' '}
                  </dd>{' '}
                </dl>{' '}
          ...
          <div className="p-5">
            ...
            <div className="flex items-center">
              ...
              <div className="flex-shrink-0 bg-green-500 rounded-md p-3">
                {' '}
                <TrendingUp className="h-6 w-6 text-[var(--color-icon-secondary)]" />{' '}
              </div>{' '}
              <div className="ml-5 w-0 flex-1">
                {' '}
                <dl>
        ...
        <div className="bg-[var(--color-body)] overflow-hidden shadow rounded-lg">
          ...
          <div className="p-5">
            ...
            <div className="flex items-center">
              {' '}
              <div className="flex-shrink-0 bg-[var(--color-accent-teal)] rounded-md p-3">
                {' '}
                <CreditCard className="bg-[var(--color-surface-raised)] border-[var(--color-border)] h-6 w-6 text-[var(--color-icon-secondary)]" />{' '}
              </div>{' '}
              <div className="ml-5 w-0 flex-1">
                {' '}
                <dl>
        ...
        <div className="bg-[var(--color-body)] overflow-hidden shadow rounded-lg">
          ...
          <div className="p-5">
            {' '}
            <div className="bg-[var(--color-body)] flex items-center">
              {' '}
              <div className="flex-shrink-0 bg-[var(--color-accent-teal)] rounded-md p-3">
                {' '}
                <Calendar className="h-6 w-6 text-[var(--color-icon-secondary)]" />{' '}
              </div>{' '}
              <div className="ml-5 w-0 flex-1">
                {' '}
                <dl>
                  ...
                  <dd className="bg-[var(--color-body)] text-sm font-semibold text-[var(--color-text-primary)] text-[var(--color-text-primary)]">
                    {' '}
      ...
      <div className="border-b border-[var(--color-border)] border-[var(--color-border)]">
        {' '}
        <nav className="bg-[var(--color-body)] -mb-px flex space-x-8">
          {' '}
          <button
      ...
      {activeTab === 'details' && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {' '}
            {/* Contact Information */}{' '}
            <div className="bg-[var(--color-body)] shadow rounded-lg p-6">
              {' '}
              <div className="flex items-center mb-4">
                {' '}
                <Phone className="h-5 w-5 text-[var(--color-text-secondary)] mr-2" />{' '}
                <h3 className="bg-[var(--color-body)] text-lg font-medium text-[var(--color-text-primary)] text-[var(--color-text-primary)]">
                  {' '}
                  Contact Information{' '}
                </h3>{' '}
              </div>{' '}
              <dl className="bg-[var(--color-body)] grid grid-cols-1 sm:grid-cols-2 gap-4">
                {' '}
                <div>
                  {' '}
                  <dt className="bg-[var(--color-body)] text-sm font-medium text-[var(--color-text-secondary)] dark:text-[var(--color-text-secondary)]">
                    Email
                  </dt>{' '}
                  <dd className="bg-[var(--color-body)] mt-1">
                    {' '}
                    {editMode ? (
                      <input
                        type="email"
                        ...
                        className="block w-full px-3 py-2 border border-[var(--color-border)] border-[var(--color-border)] rounded-md shadow-sm focus:ring-[var(--color-accent-indigo)] focus:border-[var(--color-accent-teal)] bg-muted-foreground/10 text-[var(--color-text-primary)]"
                      />
                    ) : (
                      <span className="text-sm text-[var(--color-text-primary)] text-[var(--color-text-primary)]">
                        {' '}
                        {formData.email || '-'}{' '}
                      </span>
                    )}{' '}
            ...
            <div className="bg-[var(--color-body)] shadow rounded-lg p-6">
              ...
              <div className="flex items-center mb-4">
                {' '}
                <MapPin className="h-5 w-5 text-[var(--color-text-secondary)] mr-2" />{' '}
                <h3 className="bg-[var(--color-body)] text-lg font-medium text-[var(--color-text-primary)] text-[var(--color-text-primary)]">
                  Address
                </h3>{' '}
              </div>{' '}
              {editMode ? (
                <div className="bg-[var(--color-body)] space-y-4">
                  ...
                  <div>
                    {' '}
                    <label className="bg-[var(--color-body)] block text-sm font-medium text-[var(--color-text-primary)] dark:text-[var(--color-text-secondary)] mb-1">
                      {' '}
                      Street Address{' '}
                    </label>{' '}
                    <textarea
                  ...
                  <div className="bg-[var(--color-body)] grid grid-cols-2 gap-4">
                    {' '}
                    <div>
                      {' '}
                      <label className="bg-[var(--color-body)] block text-sm font-medium text-[var(--color-text-primary)] dark:text-[var(--color-text-secondary)] mb-1">
                ...
                <div className="bg-[var(--color-body)] text-sm text-[var(--color-text-primary)] text-[var(--color-text-primary)]">
                  {' '}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[var(--color-body)] shadow rounded-lg p-6">
              ...
              <div className="flex items-center mb-4">
                {' '}
                <CreditCard className="bg-[var(--color-surface-raised)] border-[var(--color-border)] h-5 w-5 text-[var(--color-text-secondary)] mr-2" />{' '}
                <h3 className="bg-[var(--color-body)] text-lg font-medium text-[var(--color-text-primary)] text-[var(--color-text-primary)]">
                  {' '}
                  Business Information{' '}
                </h3>{' '}
              </div>{' '}
              <dl className="bg-[var(--color-body)] space-y-3">
                {' '}
                <div>
                  {' '}
                  <dt className="bg-[var(--color-body)] text-sm font-medium text-[var(--color-text-secondary)] dark:text-[var(--color-text-secondary)]">
                ...
                <div>
                  ...
                  <dd className="bg-[var(--color-body)] mt-1">
                    ...
                    {editMode ? (
                      ...
                      <span className="text-sm font-medium text-[var(--color-text-primary)] text-[var(--color-text-primary)]">
                        {' '}
                ...
                <div>
                  ...
                  <dd className="bg-[var(--color-body)] mt-1">
                    ...
                    {editMode ? (
                      ...
                      >
                        {' '}
                        <option value="Cash">Cash</option> <option value="Net 15">Net 15</option>{' '}
            ...
            <div className="bg-[var(--color-body)] shadow rounded-lg p-6">
              {' '}
              <div className="bg-[var(--color-body)] flex items-center mb-4">
                {' '}
                <FileText className="h-5 w-5 text-[var(--color-text-secondary)] mr-2" />{' '}
                <h3 className="bg-[var(--color-body)] text-lg font-medium text-[var(--color-text-primary)] text-[var(--color-text-primary)]">
                  Notes
                </h3>{' '}
              </div>{' '}
              {editMode ? (
                ...
                <p className="text-sm text-[var(--color-text-primary)] text-[var(--color-text-primary)]">
                  {' '}
                  {formData.notes || (
      ...
      {activeTab === 'transactions' && (
        <div className="bg-[var(--color-body)] shadow rounded-lg">
          {' '}
          <div className="overflow-x-auto furniture-scrollbar">
            {' '}
            <table className="bg-[var(--color-body)] min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              {' '}
              <thead className="bg-[var(--color-body)] bg-[var(--color-body)]">
                {' '}
                <tr>
                  {' '}
                  <th className="bg-[var(--color-body)] px-6 py-3 text-left text-xs font-medium text-[var(--color-text-secondary)] dark:text-[var(--color-text-secondary)] uppercase tracking-wider">
                    {' '}
                    Order Number{' '}
                  </th>{' '}
                  <th className="bg-[var(--color-body)] px-6 py-3 text-left text-xs font-medium text-[var(--color-text-secondary)] dark:text-[var(--color-text-secondary)] uppercase tracking-wider">
              ...
              <tbody className="bg-[var(--color-body)] bg-[var(--color-body)] divide-y divide-gray-200 dark:divide-gray-700">
                {' '}
                {transactions?.length === 0 ? (
                  <tr>
                    ...
                    <td
                      colSpan={5}
                      className="bg-[var(--color-body)] px-6 py-4 text-center text-[var(--color-text-secondary)] dark:text-[var(--color-text-secondary)]"
                    >
                      {' '}
                      No orders yet{' '}
                    </td>
                  ...
                  transactions?.map(transaction => (
                    <tr
                      key={transaction.id}
                      className="hover:bg-[var(--color-body)] dark:hover:bg-[var(--color-sidebar)]/30"
                    >
                      {' '}
                      <td className="bg-[var(--color-body)] px-6 py-4 whitespace-nowrap text-sm font-medium text-[var(--color-text-primary)] text-[var(--color-text-primary)]">
                        {' '}
                        {transaction.transaction_code}{' '}
                      </td>{' '}
                      <td className="bg-[var(--color-body)] px-6 py-4 whitespace-nowrap text-sm text-[var(--color-text-secondary)] dark:text-[var(--color-text-secondary)]">
                        {' '}
                        {format(new Date(transaction.transaction_date), 'MMM dd, yyyy')}{' '}
                      </td>{' '}
                      <td className="bg-[var(--color-body)] px-6 py-4 whitespace-nowrap text-sm text-[var(--color-text-primary)] text-[var(--color-text-primary)]">
                        {' '}
                      ...
                      <td className="bg-[var(--color-body)] px-6 py-4 whitespace-nowrap">
                        {' '}
