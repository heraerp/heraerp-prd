    ...
    <div className="min-h-screen bg-[var(--color-body)]">
      <div className="p-6 space-y-6">
        ...
        <form onSubmit={handleSubmit} className="bg-[var(--color-body)] space-y-6">
          <Card className="bg-[var(--color-surface-raised)] border-[var(--color-border)] p-6 bg-[var(--color-body)]/70 backdrop-blur-sm border-[var(--color-border)]/50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger className="bg-muted-foreground/10/50 border-[var(--color-border)]">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      variant="outline"
                      className={cn(
                        'w-full justify-start text-left font-normal bg-muted-foreground/10/50 border-[var(--color-border)]',
                        !formData.closingDate && 'text-[var(--color-text-secondary)]'
                      )}
                    >
          ...
          <div className="bg-[var(--color-body)] flex justify-end gap-4">
            <Button
              type="button"
              variant="outline"
              onClick={() => router.back()}
