...
export default function RetailHomePage() {
  ...
  const quickActions = [
    ...
    { 
      ...
      href: '/retail1/inventory/catalog', 
      icon: Package, 
    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="modern-card modern-primary">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Link href="/retail1/sales/pos" className="modern-btn-primary flex items-center gap-2">
              <ShoppingCart className="w-4 h-4" />
              Quick Sale
            </Link>
            <Link href="/retail1/analytics" className="modern-btn-secondary flex items-center gap-2">
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/retail1/analytics" className="modern-btn-secondary text-sm flex items-center gap-1">
            View Details
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/retail1/analytics" className="modern-btn-secondary text-sm">
              View All
            </Link>
          </div>
