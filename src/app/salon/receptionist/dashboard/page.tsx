...
export default function ReceptionistDashboard() {
  ...
  const upcomingAppointments = [
    { id: 1, time: '10:30 AM', client: 'Sarah Johnson', service: 'Hair Color & Cut', stylist: 'Emma', status: 'confirmed', phone: '+971 50 123 4567' },
    { id: 2, time: '11:00 AM', client: 'Maria Garcia', service: 'Manicure & Pedicure', stylist: 'Lisa', status: 'confirmed', phone: '+971 50 234 5678' },
    { id: 3, time: '11:30 AM', client: 'Jennifer Lee', service: 'Facial Treatment', stylist: 'Sophie', status: 'pending', phone: '+971 50 345 6789' },
    { id: 4, time: '12:00 PM', client: 'Amanda White', service: 'Hair Styling', stylist: 'Emma', status: 'confirmed', phone: '+971 50 456 7890' }
  ]
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: LUXE_COLORS.charcoal }}>
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              >
                Welcome back, {user?.user_metadata?.full_name || 'Receptionist'} • {new Date().toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' })}
              </p>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex gap-4 mt-2">
                    <span className="text-xs flex items-center gap-1" style={{ color: LUXE_COLORS.emerald }}>
                      <CheckCircle className="h-3 w-3" />
                      {todayStats.completed} done
                    </span>
                    <span className="text-xs flex items-center gap-1" style={{ color: LUXE_COLORS.orange }}>
          ...
          <Link href="/salon/appointments/new" className="block">
            ...
            >
              <CardContent className="p-6 flex flex-col items-center text-center">
                ...
                <h3 className="font-medium" style={{ color: LUXE_COLORS.champagne }}>Book Appointment</h3>
                <p className="text-xs mt-1" style={{ color: LUXE_COLORS.bronze }}>Schedule new booking</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/salon/pos2" className="block">
            ...
            >
              <CardContent className="p-6 flex flex-col items-center text-center">
                ...
                <h3 className="font-medium" style={{ color: LUXE_COLORS.champagne }}>Process Payment</h3>
                <p className="text-xs mt-1" style={{ color: LUXE_COLORS.bronze }}>Checkout & billing</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/salon/customers/new" className="block">
            ...
            >
              <CardContent className="p-6 flex flex-col items-center text-center">
                ...
                <h3 className="font-medium" style={{ color: LUXE_COLORS.champagne }}>Add Customer</h3>
                <p className="text-xs mt-1" style={{ color: LUXE_COLORS.bronze }}>Register new client</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/salon/whatsapp" className="block">
            ...
            >
              <CardContent className="p-6 flex flex-col items-center text-center">
                ...
                <h3 className="font-medium" style={{ color: LUXE_COLORS.champagne }}>WhatsApp</h3>
                <p className="text-xs mt-1" style={{ color: LUXE_COLORS.bronze }}>Send messages</p>
              </CardContent>
            </Card>
          </Link>
        </div>
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <p className="text-xs mt-1 flex items-center gap-1" style={{ color: LUXE_COLORS.bronze }}>
                            <Clock className="h-3 w-3" />
                            {apt.time}
                        ...
                        <div className="flex items-center gap-2">
                          <span 
                            ...
                            style={{
                              backgroundColor: apt.status === 'confirmed' ? `${LUXE_COLORS.emerald}20` : `${LUXE_COLORS.orange}20`,
                              color: apt.status === 'confirmed' ? LUXE_COLORS.emerald : LUXE_COLORS.orange
                            }}
                          >
                            {apt.status}
                          </span>
            ...
            <CardContent>
              {waitingClients.length > 0 ? (
                ...
                <div className="text-center py-8">
                  <Users className="h-12 w-12 mx-auto mb-3 opacity-50" style={{ color: LUXE_COLORS.bronze }} />
        ...
        <Alert className="mt-6" style={{ backgroundColor: `${LUXE_COLORS.gold}10`, border: `1px solid ${LUXE_COLORS.gold}30` }}>
          <AlertCircle className="h-4 w-4" style={{ color: LUXE_COLORS.gold }} />
          <AlertDescription style={{ color: LUXE_COLORS.champagne }}>
            <span className="font-medium">Next appointment in {todayStats.nextAppointment}</span> - Sarah Johnson for Hair Color & Cut with Emma
          </AlertDescription>
        </Alert>
      </div>
    </div>
