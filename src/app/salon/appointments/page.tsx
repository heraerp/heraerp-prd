...
import { Calendar, Clock, User, Phone, DollarSign, Plus, Search, Filter, ChevronRight, MoreVertical, Edit, Trash2, CheckCircle, XCircle, AlertCircle, CalendarDays, Loader2 } from 'lucide-react'
    ...
    <PageLayout>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <Select value={dateFilter} onValueChange={(value: any) => setDateFilter(value)}>
            ...
            <SelectContent className="hera-select-content">
              <SelectItem value="all" className="hera-select-item">Next 14 days</SelectItem>
              <SelectItem value="today" className="hera-select-item">Today</SelectItem>
              <SelectItem value="tomorrow" className="hera-select-item">Tomorrow</SelectItem>
              <SelectItem value="week" className="hera-select-item">Next 7 days</SelectItem>
            </SelectContent>
          </Select>
          ...
          <Select value={statusFilter} onValueChange={(value: any) => setStatusFilter(value)}>
            ...
            <SelectContent className="hera-select-content">
              ...
              <SelectItem value="booked" className="hera-select-item">Booked</SelectItem>
              <SelectItem value="checked_in" className="hera-select-item">Checked In</SelectItem>
              ...
              <SelectItem value="no_show" className="hera-select-item">No Show</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </Card>
      ...
      {loading ? (
        ...
        <Card className="p-12 text-center">
          ...
          {(!searchTerm && statusFilter === 'all' && dateFilter === 'all') && (
            <Button onClick={() => router.push('/salon/appointments/new')} className="dark:!text-white">
              Book Appointment
            </Button>
          )}
        </Card>
