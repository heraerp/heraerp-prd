...
import { 
  Clock, CheckCircle, TrendingUp, Shield, Users, Zap, 
  Calendar, ArrowRight, Play, Building, Heart, Factory, Briefcase,
  ChevronDown, Star, Award, Lock, Globe
} from 'lucide-react'
  ...
  const processSteps = [
    {
      ...
      icon: Clock,
      details: "Our AI-powered system captures your unique business DNA through intelligent questionnaires and process mapping."
    },
    {
      day: "Day 3-4",
    ...
    },
    {
      ...
      icon: CheckCircle,
      details: "Your complete business system goes live with real workflows, actual data structures, and custom processes."
    }
  ]
  ...
  const faqs = [
    {
      ...
      answer: "Traditional ERPs show generic templates. HERA shows YOUR actual business with YOUR processes, YOUR data structures, and YOUR workflows - all working in just one week."
    },
    {
      question: "What if my business is too complex?",
      answer: "HERA's universal architecture handles any complexity. We've successfully demonstrated systems for multi-national manufacturers, hospital networks, and restaurant chains - all within 7 days."
    },
    {
      question: "How secure is my data during the demo?",
      answer: "Your demo runs in a completely isolated environment with enterprise-grade security. All data is encrypted, and you maintain full control. After the demo, you can export or delete everything."
    },
    {
      question: "What happens after the week?",
      answer: "You'll have a fully functional system ready for production. Most clients go live within 2-4 weeks total, compared to 12-24 months with traditional ERPs."
    }
  ]
      ...
      <div className="relative z-10 w-full">
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-2xl font-bold text-violet-600">{industry.metrics.timeSaved}</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-2xl font-bold text-green-600">{industry.metrics.costReduction}</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-2xl font-bold text-cyan-600">{industry.metrics.efficiency}</p>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <div className="bg-gray-100 rounded p-3 text-sm">
                              Multiple disconnected systems, manual processes, no real-time visibility
                            </div>
                          </div>
                          <div>
              ...
              {[1, 2, 3].map((i) => (
                <Card key={i} className="p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    "The speed is unbelievable. We went from initial consultation to 
                    seeing our entire operation running on HERA in just 10 days."
                  </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6">
                ...
                <div className="bg-violet-50 rounded p-4">
                  <p className="text-sm font-mono text-violet-700">
                    core_organizations<br/>
                    core_entities<br/>
                    core_relationships<br/>
                    universal_transactions<br/>
                    universal_transaction_lines<br/>
                    core_dynamic_data
                  </p>
                </div>
              </Card>
              ...
              <Card className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Every business process is encoded with intelligent patterns that enable 
                  instant configuration and automation.
                </p>
                <div className="bg-cyan-50 rounded p-4">
                  <p className="text-sm font-mono text-cyan-700">
                    HERA.REST.POS.SALE.v1<br/>
                    HERA.HLTH.PAT.VISIT.v1<br/>
                    HERA.MFG.PROD.ORDER.v1<br/>
              ...
              <Card className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Built from the ground up with AI integration, enabling intelligent 
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Card className="p-8 max-w-md mx-auto">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <p className="text-sm text-gray-600 font-medium">
                  ✓ No setup fees for preview week<br/>
                  ✓ If you don't see value in 14 days, we'll refund your time<br/>
                  ✓ Your competitors are already seeing their future
                </p>
              </div>
            </Card>
          </div>
        ...
        <footer className="py-8 px-4 bg-gray-900 text-white">
          <div className="max-w-7xl mx-auto text-center">
            <img src="/logo.png" alt="HERA" className="h-12 w-auto mx-auto mb-4 filter brightness-0 invert" />
