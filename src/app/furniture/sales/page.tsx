...
export default function FurnitureSales() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'delivered':
        return 'bg-[var(--color-body)] bg-[var(--color-body)]/30 text-[var(--color-text-primary)] dark:text-[var(--color-text-secondary)]'
      case 'paid':
        return 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300'
      case 'unpaid':
      ...
      <div className="min-h-screen bg-[var(--color-body)] flex items-center justify-center">
        <div className="text-center">
          ...
          <Button
            onClick={refresh}
            variant="outline"
            className="gap-2 hover:bg-[var(--color-hover)]"
          >
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="bg-[var(--color-surface-raised)] border-[var(--color-border)] p-6 bg-[var(--color-body)]/50 backdrop-blur-sm border-[var(--color-border)]/50 hover:bg-[var(--color-body)]/70 transition-all">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-[var(--color-body)]/20 rounded-xl">
                <ShoppingCart className="h-6 w-6 text-[var(--color-icon-secondary)]" />{' '}
              </div>
              <Badge
                variant="secondary"
                className="bg-[var(--color-body)]/20 text-[var(--color-text-secondary)]"
              >
                Live
              </Badge>
            </div>
          ...
          <Card className="bg-[var(--color-surface-raised)] border-[var(--color-border)] p-6 bg-[var(--color-body)]/50 backdrop-blur-sm border-[var(--color-border)]/50 hover:bg-[var(--color-body)]/70 transition-all">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-[var(--color-body)]/10 rounded-xl">
                <FileText className="h-6 w-6 text-[var(--color-icon-secondary)]" />{' '}
              </div>
              <Badge
                variant="secondary"
                className="bg-[var(--color-body)]/10 text-[var(--color-text-secondary)]"
              >
                Pending
              </Badge>
            </div>
          ...
          <Card className="bg-[var(--color-surface-raised)] border-[var(--color-border)] p-6 bg-[var(--color-body)]/50 backdrop-blur-sm border-[var(--color-border)]/50 hover:bg-[var(--color-body)]/70 transition-all">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-[var(--color-body)]/10 rounded-xl">
                <Truck className="h-6 w-6 text-[var(--color-icon-secondary)]" />{' '}
              </div>
              <Badge
                variant="secondary"
                className="bg-[var(--color-body)]/10 text-[var(--color-text-secondary)]"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="divide-y divide-gray-700/50">
                ...
                {recentOrders.length === 0 ? (
                  ...
                  recentOrders.map(order => (
                    <div
                      key={order.id}
                      className="p-4 hover:bg-[var(--color-body)]/30 transition-colors"
                    >
                      <div className="flex items-center justify-between">
                          ...
                          <div className="bg-[var(--color-body)] flex items-start justify-between">
                            <div>
                              ...
                              <div className="bg-[var(--color-body)] flex items-center gap-4 mt-2 text-xs text-[var(--color-text-secondary)]">
                                ...
                                <span className="flex items-center gap-1">
                                  <Package className="h-3 w-3" /> {order.items} items{' '}
                                </span>
                                <span className="flex items-center gap-1">
                                  <Truck className="h-3 w-3" /> {order.deliveryDate}{' '}
                                </span>{' '}
                              </div>{' '}
                            </div>
                        ...
                        <div className="flex items-center gap-2 ml-4">
                          <Link href={`/furniture/sales/orders/${order.id}`}>
                            <Button
                              variant="ghost"
                              size="icon"
                              className="h-8 w-8 hover:bg-[var(--color-hover)]"
                            >
          ...
          <div className="space-y-4">
            ...
            {/* Top Products */}{' '}
            <div>
              <h2 className="bg-[var(--color-body)] text-xl font-semibold text-[var(--color-text-primary)] mb-4">
                Top Products
              </h2>
              <Card className="bg-[var(--color-surface-raised)] border-[var(--color-border)] bg-[var(--color-body)]/50 backdrop-blur-sm border-[var(--color-border)]/50">
                    ...
                    topProducts.map((product, index) => (
                      ...
                      >
                        <div className="bg-[var(--color-body)] flex items-center gap-3">
                          <div className="w-8 h-8 bg-muted-foreground/10/50 rounded-lg flex items-center justify-center text-xs font-medium text-[var(--color-text-secondary)]">
                            {' '}
                            {index + 1}{' '}
                          </div>
                          <div>
