...
export default function NewCustomerPage() {
  ...
  const handleInputChange = (
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      setLoading(true)
      try {
        // Set organization context universalApi.setOrganizationId(organizationId!)
    ...
    return (
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {/* Form */}{' '}
        <form onSubmit={handleSubmit} className="bg-[var(--color-body)] space-y-6">
          {' '}
          {/* Basic Information */}{' '}
          <div className="bg-[var(--color-body)] shadow rounded-lg p-6">
            ...
            <div className="flex items-center mb-4">
              {' '}
              <Building2 className="h-5 w-5 text-[var(--color-text-secondary)] mr-2" />{' '}
              <h2 className="bg-[var(--color-body)] text-lg font-medium text-[var(--color-text-primary)] text-[var(--color-text-primary)]">
                Basic Information
              </h2>{' '}
            </div>{' '}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                {' '}
                <label className="bg-[var(--color-body)] block text-sm font-medium text-[var(--color-text-primary)] dark:text-[var(--color-text-secondary)] mb-2">
                  {' '}
          ...
          {/* Actions */}{' '}
          <div className="bg-[var(--color-body)] flex justify-end space-x-4">
            {' '}
            <Link
              href="/furniture/sales/customers"
              className="px-4 py-2 border border-[var(--color-border)] border-[var(--color-border)] text-sm font-medium rounded-md text-[var(--color-text-primary)] dark:text-[var(--color-text-primary)] bg-[var(--color-body)] bg-muted-foreground/10 hover:bg-[var(--color-body)] dark:hover:bg-[var(--color-body)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
            >
              {' '}
              Cancel{' '}
            </Link>{' '}
            ...
            >
              ...
              {loading ? (
                ...
                <>
                  {' '}
                  <Save className="h-4 w-4 mr-2" /> Create Customer{' '}
                </>
              )}{' '}
            </button>{' '}
          </div>{' '}
