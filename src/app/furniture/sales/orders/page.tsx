...
export default function FurnitureSalesOrders() {
  ...
  const loadData = async () => {
    try {
      ...
      // Transform orders with customer names
  ...
  const getStatusBadge = (status: string) => {
    const statusConfig = {
      ...
      in_production: { variant: 'outline' as const, label: 'In Production' },
              ...
              <Card className="p-4 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-white/20 dark:border-gray-700/50">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {loading ? '...' : `₹${(stats.avgOrderSize / 100000).toFixed(1)}L`}
                    </p>
                  </div>
              ...
              <Card className="p-4 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-white/20 dark:border-gray-700/50">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">{loading ? '...' : stats.pendingDelivery}</p>
                  </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <Card className="p-4 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border-blue-200 dark:border-blue-800">
                  <h3 className="font-semibold mb-3 text-blue-900 dark:text-blue-100">Proforma</h3>
                  <div className="space-y-2">
                    <p className="text-2xl font-bold text-blue-900 dark:text-blue-100">₹45L</p>
                    <p className="text-sm text-blue-700 dark:text-blue-300">5 quotes</p>
                  </div>
                </Card>
                ...
                <Card className="p-4 bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20 border-amber-200 dark:border-amber-800">
                  <h3 className="font-semibold mb-3 text-amber-900 dark:text-amber-100">Pending</h3>
                  <div className="space-y-2">
                    <p className="text-2xl font-bold text-amber-900 dark:text-amber-100">₹1.2Cr</p>
                    <p className="text-sm text-amber-700 dark:text-amber-300">8 orders</p>
                  </div>
                </Card>
