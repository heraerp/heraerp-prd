  ...
  const renderAccount = (account: GLAccountNode, level: number = 0): React.ReactNode => {
    ...
    return (
      <div key={account.entity_code}>
        <div
          className={cn(
            'grid grid-cols-12 gap-4 py-2 px-3 hover:bg-muted/50 transition-colors border-b border-gray-800',
        ...
        >
          ...
          <div className="col-span-1 flex items-center">
            <Badge
              ...
              className={cn(
                'text-xs border-0',
                isHeader ? 'bg-blue-500/20 text-blue-400' : 'bg-muted-foreground/10/50 text-muted-foreground'
              )}
            >
    ...
    <div className="min-h-screen bg-background">
      <div className="p-6 space-y-6">
            ...
            <AlertDescription>
              <div className="flex items-center justify-between">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className="ml-4 border-amber-600 text-amber-600 hover:bg-amber-600 hover:text-foreground"
                  onClick={() => {
                    if (error) {
                      loadChartOfAccounts()
                    } else {
        ...
        <Card className="bg-muted/50 border-border overflow-hidden">
          {/* Table Header */}
          <div className="grid grid-cols-12 gap-4 py-3 px-3 bg-background/50 border-b border-border font-semibold text-sm text-gray-300">
          ...
          {/* Table Footer */}
          {accounts.length > 0 && (
            <div className="grid grid-cols-12 gap-4 py-3 px-3 bg-background/50 border-t border-border font-bold text-sm">
