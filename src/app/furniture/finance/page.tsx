...
export default function FurnitureFinance() {
  ...
  // Group accounts by category for tree view
  const accountTree = {
    '1000000': glAccounts.filter(a => a.entity_code.startsWith('1')),
    '2000000': glAccounts.filter(a => a.entity_code.startsWith('2')),
    '3000000': glAccounts.filter(a => a.entity_code.startsWith('3')),
    '4000000': glAccounts.filter(a => a.entity_code.startsWith('4')),
    '5000000': glAccounts.filter(a => a.entity_code.startsWith('5'))
  }
              ...
              <Card className="p-6 bg-gray-800/50 border-gray-700">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { name: 'Profit & Loss Statement', icon: TrendingUp, date: 'YTD 2025' },
