    ...
    try {
      ...
      const inspectionData = qualityInspections.map((inspection: any, index: number) => {
        ...
        return {
          ...
          product_code: product?.entity_code || 'N/A',
          batch_number: `BATCH-2025-${String(index + 1).padStart(4, '0')}`,
          inspection_type: ['incoming', 'in_process', 'final', 'random'][index % 4],
      ...
      setIssues(issueData)
      setMetrics({
        overallQualityRate: avgPassRate,
    ...
    <div className="min-h-screen bg-gray-900">
      <div className="p-6 space-y-6">
        ...
        <FurniturePageHeader
          ...
          subtitle="Monitor quality inspections and track issues"
          actions={
            <>
