      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">{product.entity_name}</h1>
              <p className="text-muted-foreground">{product.entity_code}</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-muted/50 border-border">
              <CardContent className="p-6">
                <div className="aspect-square bg-muted-foreground/10/50 rounded-lg flex items-center justify-center">
            ...
            <Card className="bg-muted/50 border-border">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <p className="text-sm text-muted-foreground">Smart Code</p>
