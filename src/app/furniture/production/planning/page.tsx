      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="p-6 bg-muted/50 backdrop-blur-sm border-border/50">
            ...
            <p className="text-2xl font-bold text-foreground">{Object.keys(demandByProduct).length}</p>
            <p className="text-sm text-muted-foreground mt-1">Products in demand</p>
          </Card>
          ...
          <Card className="p-6 bg-muted/50 backdrop-blur-sm border-border/50">
            ...
            <p className="text-2xl font-bold text-foreground">{workCenters.length * 8}</p>
            <p className="text-sm text-muted-foreground mt-1">Hours available today</p>
          </Card>
          ...
          <Card className="p-6 bg-muted/50 backdrop-blur-sm border-border/50">
            ...
            <p className="text-sm text-muted-foreground mt-1">Material shortages</p>
          </Card>
          ...
          <Card className="p-6 bg-muted/50 backdrop-blur-sm border-border/50">
            ...
            <p className="text-sm text-muted-foreground mt-1">Delivery performance</p>
          </Card>
        </div>
        ...
        <Tabs defaultValue="demand" className="space-y-4">
          ...
          <TabsContent value="demand" className="space-y-4">
            <Card className="bg-muted/50 backdrop-blur-sm border-border/50">
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-semibold text-foreground">Product Demand Analysis</h2>
                  <Button variant="outline" size="sm" className="gap-2">
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-right">
                            <p className="text-lg font-semibold text-foreground">{demand} units</p>
                            <Badge
                              className={
                                hasOrders
          ...
          <TabsContent value="capacity" className="space-y-4">
            <Card className="bg-muted/50 backdrop-blur-sm border-border/50">
              <div className="p-6">
                <h2 className="text-xl font-semibold text-foreground mb-4">Work Center Capacity</h2>
                  ...
                  {workCenters.map(center => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-3">
                        <div>
                          <p className="font-medium text-foreground">{center.entity_name}</p>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="text-foreground">8 hours</span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-muted-foreground">Scheduled</span>
                          <span className="text-foreground">6.5 hours</span>
                        </div>
                        <div className="flex justify-between text-sm">
                ...
                <div className="space-y-4">
                  {rawMaterials.map(material => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="font-medium text-foreground">{material.entity_name}</p>
                          <p className="text-sm text-muted-foreground">{material.entity_code}</p>
                        </div>
                        <div className="text-right">
          ...
          <TabsContent value="schedule" className="space-y-4">
            <Card className="p-6 bg-muted/50 backdrop-blur-sm border-border/50">
              <h3 className="text-lg font-semibold text-foreground mb-4">Master Production Schedule</h3>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Card className="p-4 hover:scale-105 transition-transform cursor-pointer bg-muted/30 backdrop-blur-sm border-border/30">
            <Link href="/furniture/production/orders/new">
