...
export default function NewBidPage() {
  ...
  return (
    <div>
      ...
      />{' '}
      <div className="bg-[var(--color-body)] grid grid-cols-1 lg:grid-cols-3 gap-6">
        {' '}
        <div className="lg:col-span-2">
          ...
          <Card className="bg-[var(--color-surface-raised)] border-[var(--color-border)] p-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="basic" className="bg-[var(--color-body)] space-y-4 mt-6">
                {' '}
                <div>
                  {' '}
                  ...
                  <Input
                    ...
                    className="bg-[var(--color-body)] text-lg font-semibold"
                  />{' '}
                ...
                <div>
                  ...
                  <RadioGroup value={bidStrategy} onValueChange={setBidStrategy}>
                    {' '}
                    <div className="bg-[var(--color-body)] flex items-center space-x-2">
                      {' '}
                      <RadioGroupItem value="aggressive" id="aggressive" />{' '}
                      <Label htmlFor="aggressive">
                        Aggressive (Low margin, high win chance)
                      </Label>{' '}
                    </div>
                    <div className="bg-[var(--color-body)] flex items-center space-x-2">
                      {' '}
                    ...
                    <div className="bg-[var(--color-body)] flex items-center space-x-2">
                      ...
                      <Label htmlFor="conservative">
                        Conservative (High margin, low risk)
                      </Label>{' '}
                    </div>{' '}
                  </RadioGroup>{' '}
                </div>
              ...
              <TabsContent value="technical" className="bg-[var(--color-body)] space-y-4 mt-6">
                {' '}
                <div>
                  {' '}
              ...
              <TabsContent value="commercial" className="bg-[var(--color-body)] space-y-4 mt-6">
                {' '}
                <h3 className="bg-[var(--color-body)] font-semibold mb-4">Price Breakdown</h3>{' '}
                <div className="space-y-4">
                  ...
                  <div className="bg-[var(--color-body)] pt-4 border-t">
                    {' '}
              ...
              <TabsContent value="documents" className="bg-[var(--color-body)] space-y-4 mt-6">
                {' '}
                <div>
                  {' '}
                  <h3 className="bg-[var(--color-body)] font-semibold mb-4">
                    Required Documents
                  </h3>{' '}
                  <div className="space-y-3">
                    ...
                    {requiredDocuments.map(doc => (
                      <div
                        key={doc.id}
                        className="bg-[var(--color-body)] flex items-center space-x-2"
                      >
                        {' '}
                        <Checkbox
                          id={doc.id}
                        ...
                        <Label
                          htmlFor={doc.id}
                          className="bg-[var(--color-body)] font-normal cursor-pointer"
                        >
                          {doc.label}
                        </Label>
                ...
                <div className="pt-4">
                  {' '}
                  <h3 className="bg-[var(--color-body)] font-semibold mb-4">Declarations</h3>{' '}
                  <div className="space-y-3">
                    {' '}
                    {declarations.map(dec => (
                      <div
                        key={dec.id}
                        className="bg-[var(--color-body)] flex items-start space-x-2"
                      >
                        {' '}
                        <Checkbox
                          id={dec.id}
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-[var(--color-surface-raised)] border-[var(--color-border)] p-6">
            {' '}
            <h3 className="bg-[var(--color-body)] font-semibold mb-4 flex items-center">
              {' '}
              <FileText className="h-5 w-5 mr-2" /> Tender Summary{' '}
            </h3>{' '}
            <div className="space-y-3 text-sm">
              {' '}
              <div>
                {' '}
                <p className="text-[var(--color-text-secondary)]">Tender Code</p>{' '}
              ...
              <div>
                {' '}
                <p className="text-[var(--color-text-secondary)]">EMD Amount</p>{' '}
                <p className="font-medium">₹90,000</p>{' '}
              </div>
              <div>
                {' '}
                <p className="text-[var(--color-text-secondary)]">Closing Date</p>{' '}
          ...
          {/* AI Insights */}{' '}
          {showAiInsights && (
            <Card className="bg-[var(--color-surface-raised)] border-[var(--color-border)] p-6 bg-gradient-to-br from-[var(--color-accent-teal)]-50 to-blue-50 dark:from-[var(--color-accent-teal)]-950 dark:to-blue-950">
              {' '}
              <h3 className="bg-[var(--color-body)] font-semibold mb-4 flex items-center">
                {' '}
                <Brain className="h-5 w-5 mr-2" /> AI Bid Insights{' '}
              </h3>{' '}
              <div className="space-y-3">
                {' '}
                <Alert>
                  ...
                  <AlertDescription>
                    {' '}
                    <strong>Optimal Bid Range:</strong> ₹42,00,000 - ₹44,50,000 <br /> Based on
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    {' '}
                    <strong>Competition:</strong> Expect 8-10 bidders <br /> Key competitor:
                    Nilambur Wood Products{' '}
                  </AlertDescription>{' '}
                </Alert>{' '}
                <Alert>
                  {' '}
                  ...
                  <AlertDescription>
                    ...
                    <ul className="bg-[var(--color-body)] list-disc list-inside mt-1">
                      {' '}
                      <li>Emphasize quality certifications</li> <li>Highlight local presence</li>{' '}
          ...
          <Card className="bg-[var(--color-surface-raised)] border-[var(--color-border)] p-6">
            {' '}
            <h3 className="bg-[var(--color-body)] font-semibold mb-4">Bid Completion</h3>{' '}
            <div className="space-y-3">
              {' '}
              <div className="flex justify-between text-sm">
                {' '}
                <span>Basic Details</span> <span className="text-green-600">Complete</span>{' '}
              </div>
              <div className="flex justify-between text-sm">
                {' '}
              ...
              <div className="flex justify-between text-sm">
                ...
                <span
                  className={
                    calculateTotalBid() > 0 ? 'text-green-600' : 'text-[var(--color-text-primary)]'
                  }
                >
                  {' '}
