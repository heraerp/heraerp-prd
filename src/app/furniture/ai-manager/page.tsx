  ...
  const [messages, setMessages] = useState<AIMessage[]>([
    {
      id: '1',
      type: 'assistant',
      content: `Hello! I'm your AI Business Manager for ${organizationName || 'your furniture business'}. I provide real-time insights and help you make data-driven decisions. I can help you with:
• 📊 Business performance analysis
• 🎯 Goal tracking and recommendations
• ⚠️ Risk identification and mitigation
• 💡 Growth opportunity suggestions
• 👥 Team performance optimization
• 📦 Inventory management insights What would you like to know about your business today?`,
      timestamp: new Date(),
      category: 'strategy',
      actionable: true
    }
  ...
  return (
      <div className="min-h-screen bg-[var(--color-body)] flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <p className="text-[var(--color-text-secondary)]">Loading AI Manager...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="p-6 space-y-6">
          ...
          actions={
            <>
              <Button
                ...
                className="bg-[var(--color-body)] gap-2"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3">
            <Card className="bg-[var(--color-surface-raised)] border-[var(--color-border)] h-[600px] flex flex-col bg-[var(--color-body)]/50 border-[var(--color-border)]">
              {/* Category Tabs */}
                ...
                <div className="flex gap-2 overflow-x-auto">
                  {MANAGEMENT_CATEGORIES.map(cat => (
                    <Button
                      ...
                      className="bg-[var(--color-body)] gap-2 whitespace-nowrap"
                    >
                      <cat.icon className="bg-[var(--color-body)] h-4 w-4" />
                      {cat.label}
                    </Button>
                  ))}
                </div>
              ...
              <form onSubmit={handleSubmit} className="bg-[var(--color-body)] p-4 border-t border-[var(--color-border)]">
                <div className="flex gap-2">
                  <Input
                    ...
                    disabled={loading}
                    className="flex-1 bg-[var(--color-body)]/50 border-[var(--color-border)]"
                  />
          ...
          <div className="space-y-4">
            ...
            <Card className="bg-[var(--color-surface-raised)] border-[var(--color-border)] bg-[var(--color-body)]/50 border-[var(--color-border)]">
              ...
              <CardContent className="space-y-3">
                <div className="space-y-2">
                  <div className="bg-[var(--color-body)] flex items-center gap-2 text-xs">
            ...
            <Card className="bg-[var(--color-surface-raised)] border-[var(--color-border)] bg-[var(--color-body)]/50 border-[var(--color-border)]">
              ...
              <CardContent className="space-y-2">
                ...
                <Alert className="bg-[var(--color-body)]/20 border-[#6b6975]/30">
