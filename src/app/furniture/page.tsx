  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <div className="p-6 space-y-6">
                    ...
                    <div key={center.label} className="space-y-2">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <center.icon className="h-4 w-4 text-muted-foreground" />
              ...
              <Card className="p-6 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-amber-600">5 overdue</p>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <Card className="p-6 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-amber-600">Due: 25th Jan</p>
                </div>
              </Card>
              ...
              <Card className="p-6 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm">
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm text-muted-foreground">PF Remittance</p>
                  </div>
              ...
              <Card className="p-6 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm">
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm text-muted-foreground">ESI Status</p>
                  </div>
                  <p className="text-lg font-semibold">Pending</p>
                  <p className="text-sm text-amber-600">Submit by 31st Jan</p>
                </div>
              </Card>
            </div>
          </TabsContent>
        ...
        {/* Module Navigation */}
        <div className="space-y-4">
          <h2 className="text-xl font-semibold">Furniture Modules</h2>
