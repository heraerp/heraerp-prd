          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="relative group">
              ...
              <div className="relative bg-background/5 backdrop-blur-xl border border-border/10 rounded-2xl p-6">
                ...
                <h3 className="text-foreground/60 text-sm font-medium mb-1">Total Receivable</h3>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-background/5 backdrop-blur-xl border border-border/10 rounded-2xl p-6">
                ...
                <p className="text-xs text-foreground/40 mt-1">28 overdue invoices</p>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-background/5 backdrop-blur-xl border border-border/10 rounded-2xl p-6">
                ...
                <h3 className="text-foreground/60 text-sm font-medium mb-1">Avg Collection Days</h3>
                <p className="text-2xl font-bold text-foreground">
                  {arMetrics.averageCollectionDays} days
                </p>
                <p className="text-xs text-foreground/40 mt-1">Below target</p>
              </div>
            </div>
          </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                        <div>
                          <p className="text-xs text-foreground/60 mb-1">Total Receivable</p>
