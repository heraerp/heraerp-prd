...
const DOCS_PASSWORD_HASH =
  process.env.DOCS_PASSWORD_HASH || '$2a$12$K.gW.HW8HhV2rW.ZQZPYOOzH0qI0JvDMFhO5yM7PqB6cYwAk9B5K2' // Default: "HeraDocsSecure2024!"
...
export async function authenticateDocs(
  password: string
