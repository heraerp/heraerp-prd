...
export function HeraProgress({
  ...
  return (
    <div className={cn('space-y-2', className)}>
      ...
      {/* Progress Bar */}
      <div className={cn('hera-progress-bar', sizeClasses[size], 'relative overflow-hidden')}>
        <div
          className={cn('hera-progress-fill', variantClasses[variant], animatedClass, 'relative')}
...
export function HeraWealthProgress({ className, ...props }: Omit<HeraProgressProps, 'variant'>) {
  return (
    <HeraProgress variant="gradient" size="lg" animated={true} className={className} {...props} />
  )
}
