...
import { useConnectIntegration, useDisconnectIntegration, useSyncIntegration, useUpdateConnectorSchedule } from '@/hooks/use-integrations';
      ...
      <Dialog open={showScheduleDialog} onOpenChange={setShowScheduleDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Configure automatic sync schedule for {name}.
            </DialogDescription>
          </DialogHeader>
