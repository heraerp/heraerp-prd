      ...
      <div className="space-y-6 pt-6 pb-4 overflow-y-auto px-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select value={formData.status} onValueChange={(value) => setFormData({ ...formData, status: value })}>
                ...
                >
                  ...
                  <SelectItem value="inactive" style={{ color: LUXE_COLORS.bronze }}>Inactive</SelectItem>
                  <SelectItem value="on_leave" style={{ color: LUXE_COLORS.gold }}>On Leave</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div>
              ...
              <Select value={formData.supervisor_id || 'none'} onValueChange={(value) => setFormData({ ...formData, supervisor_id: value === 'none' ? '' : value })}>
                <SelectTrigger 
                  className="h-11"
                  style={{
                    backgroundColor: `${LUXE_COLORS.charcoal}80`,
                ...
                >
                  <SelectItem value="none" style={{ color: LUXE_COLORS.lightText }}>None</SelectItem>
                  {existingStaff
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData({ ...formData, display_rate: parseFloat(e.target.value) || 0 })}
                  placeholder="150.00"
                  step="0.01"
                  className="h-11 focus:ring-2 focus:ring-gold/50 transition-all"
                  style={{
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="max-h-48 overflow-y-auto space-y-2 p-3 rounded-lg" style={{ backgroundColor: `${LUXE_COLORS.charcoal}50` }}>
