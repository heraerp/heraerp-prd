...
export function MicrosoftSalonCalendar({ className, onNewBooking }: MicrosoftSalonCalendarProps) {
  ...
  const stylists = [
    { id: 'rocky', name: 'Rocky', title: 'Celebrity Hair Artist', avatar: 'R', color: 'bg-purple-600', available: true, status: 'available' },
    { id: 'vinay', name: 'Vinay', title: 'Senior Stylist', avatar: 'V', color: 'bg-blue-600', available: true, status: 'busy' },
    { id: 'maya', name: 'Maya', title: 'Color Specialist', avatar: 'M', color: 'bg-pink-600', available: false, status: 'away' },
    { id: 'sophia', name: 'Sophia', title: 'Bridal Specialist', avatar: 'S', color: 'bg-amber-600', available: true, status: 'available' }
  ]
        ...
        <div className="w-80 border-r border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 flex flex-col calendar-sidebar">
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="p-4 border-t border-gray-200 dark:border-gray-700">
              <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Today's Appointments</h4>
              <div className="space-y-2">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <span className="text-xs text-gray-600 dark:text-gray-300">{apt.time}</span>
                          <span className="text-xs text-gray-400">•</span>
                          <span className="text-xs text-gray-600 dark:text-gray-300">{apt.price}</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <ScrollArea className="w-full calendar-scrollbar">
                <div className="flex">
                  {weekDates.map((date, dayIdx) => {
                    ...
                    return (
                      <div key={dayIdx} className="flex-1 min-w-[140px] border-r border-gray-200 dark:border-gray-700 last:border-r-0">
                        {/* Day Header */}
                        <div className={cn(
                        ...
                        <div>
                          {timeSlots.map((slot, slotIdx) => {
                            ...
                            const slotAppointments = appointments.filter(apt => 
                              apt.time === slot.time && (selectedStylist === 'all' || apt.stylist === selectedStylist)
                            )
