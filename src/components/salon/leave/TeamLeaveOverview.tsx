  ...
  return (
    ...
    >
      <div className="p-6">
        ...
        {/* Department Coverage */}
        <div className="mb-6">
          <h4 className="text-sm font-medium ink dark:text-gray-300 mb-3">Department Coverage</h4>
        ...
        <div>
          <h4 className="text-sm font-medium ink dark:text-gray-300 mb-3">Team Members</h4>
