...
export function LeaveRequestForm({ onClose, organizationId }: LeaveRequestFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const request = {
      ...
      partialDays: formData.partialDay !== 'full' ? {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            >
              ...
              <SelectContent className="hera-select-content">
                ...
                <SelectItem value="maternity" className="hera-select-item">Maternity Leave</SelectItem>
                <SelectItem value="paternity" className="hera-select-item">Paternity Leave</SelectItem>
                <SelectItem value="bereavement" className="hera-select-item">Bereavement Leave</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          {/* Partial Day Option */}
          <div>
            <Label htmlFor="partialDay" className="!text-gray-300">Day Type</Label>
            <Select
            ...
            >
              ...
              <SelectContent className="hera-select-content">
                <SelectItem value="full" className="hera-select-item">Full Day(s)</SelectItem>
                <SelectItem value="half" className="hera-select-item">Half Day(s)</SelectItem>
                <SelectItem value="am" className="hera-select-item">Morning Only</SelectItem>
                <SelectItem value="pm" className="hera-select-item">Afternoon Only</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          {/* Coverage Notes */}
          <div>
            <Label htmlFor="coverageNotes" className="!text-gray-300">Coverage Arrangements (Optional)</Label>
            <Textarea
              id="coverageNotes"
