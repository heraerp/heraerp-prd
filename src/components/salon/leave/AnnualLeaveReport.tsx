...
import { FileText, Download, Users, Calendar, TrendingUp, BarChart3, Printer, Mail } from 'lucide-react'
      ...
      >
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="space-y-4">
            ...
            <div>
              <Label htmlFor="fiscalYearEnd" className="!text-gray-300">Fiscal Year End</Label>
              <Input
                id="fiscalYearEnd"
                type="date"
          ...
          <div className="space-y-4">
            <div>
              <Label htmlFor="groupBy" className="!text-gray-300">Group By</Label>
              <Select
                value={reportOptions.groupBy}
                onValueChange={(value: any) => setReportOptions({
                  ...reportOptions,
                  groupBy: value
                })}
              >
                ...
                <SelectContent className="hera-select-content">
                  <SelectItem value="employee" className="hera-select-item">Employee</SelectItem>
                  <SelectItem value="department" className="hera-select-item">Department</SelectItem>
                  <SelectItem value="leave_type" className="hera-select-item">Leave Type</SelectItem>
                </SelectContent>
              </Select>
            </div>

            <div>
              <Label htmlFor="format" className="!text-gray-300">Report Format</Label>
              <Select
              ...
              >
                ...
                <SelectContent className="hera-select-content">
                  <SelectItem value="summary" className="hera-select-item">Summary</SelectItem>
                  <SelectItem value="detailed" className="hera-select-item">Detailed</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-700">
                  <th className="px-4 py-3 text-left text-xs font-medium !text-gray-500 dark:!text-gray-400 uppercase tracking-wider">
                    {reportOptions.groupBy === 'employee' ? 'Employee' : 
                     reportOptions.groupBy === 'department' ? 'Department' : 'Leave Type'}
                  </th>
                  <th className="px-4 py-3 text-left text-xs font-medium !text-gray-500 dark:!text-gray-400 uppercase tracking-wider">
                    Opening Balance
                  </th>
              ...
              <tbody className="divide-y divide-gray-700">
                ...
                <tr className="hover:bg-gray-800/50">
                  ...
                  <td className="px-4 py-3 text-sm font-medium !text-gray-900 dark:!text-white">11</td>
                </tr>
                <tr className="hover:bg-gray-800/50">
                  <td className="px-4 py-3 text-sm !text-gray-900 dark:!text-white">
                  ...
                  <td className="px-4 py-3 text-sm !text-gray-600 dark:!text-gray-400">0</td>
                  <td className="px-4 py-3 text-sm font-medium !text-gray-900 dark:!text-white">12</td>
                </tr>
              </tbody>
            </table>
          </div>
