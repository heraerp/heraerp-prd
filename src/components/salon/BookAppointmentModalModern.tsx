      ...
      >
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          >
            ...
            >
              <TabsList className="grid w-full max-w-md grid-cols-3 bg-black/30 backdrop-blur-xl border border-white/10">
                <TabsTrigger
                  value="quick"
                            ...
                            {customers
                              ...
                              .map(customer => (
                                <Button
                                  ...
                                  variant="outline"
                                  className={cn(
                                    'justify-start gap-3 bg-black/30 border-white/10 hover:bg-white/10',
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {services.map(service => (
                          <Button
                            ...
                            variant="outline"
                            className={cn(
                              'justify-between h-auto py-3 px-4 bg-black/30 border-white/10 hover:bg-white/10',
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {stylists.map(stylist => (
                          <Button
                            ...
                            variant="outline"
                            className={cn(
                              'justify-start gap-3 h-auto py-3 bg-black/30 border-white/10 hover:bg-white/10',
