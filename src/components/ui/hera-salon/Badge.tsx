  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outline: 
          "border-hera-line-200 text-hera-ink dark:border-hera-border dark:text-hera-ink",
        success:
        ...
        primary:
          "border-transparent bg-hera-primary-100 text-hera-primary-700 dark:bg-hera-primary-900/30 dark:text-hera-primary-400",
        pink:
          "border-transparent bg-hera-pink-100 text-hera-pink-700 dark:bg-hera-pink-900/30 dark:text-hera-pink-400",
        teal:
          "border-transparent bg-hera-teal-100 text-hera-teal-700 dark:bg-hera-teal-900/30 dark:text-hera-teal-400",
      },
    },
    defaultVariants: {
      variant: "default",
