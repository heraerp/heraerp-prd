...
export function BackgroundGradient({
  ...
  const gradientVariants = {
    ...
    enterprise: "bg-[conic-gradient(from_var(--gradient-angle,0deg),var(--surface-glass),var(--ink-primary),var(--surface-glass))]",
    rainbow: "bg-[conic-gradient(from_var(--gradient-angle,0deg),#ff0000,#ff8c00,#ffd700,#008000,#0000ff,#4b0082,#8b00ff,#ff0000)]",
  ...
  return (
    <div
      ...
      style={{
        background: variant === "enterprise" && animate
      ...
      <div
        className={cn(
          ...
          animate && variant !== "enterprise" && [
            ...
            variant === "rainbow" && "from-red-500 via-yellow-500 via-green-500 via-blue-500 to-purple-500",
            variant === "aurora" && "from-emerald-500 via-blue-500 to-purple-600"
          ],
          animate && variant === "enterprise" && "bg-[conic-gradient(from_var(--gradient-angle,0deg),rgba(255,255,255,0.1),var(--ink-primary),rgba(255,255,255,0.1))]"
        )}
        style={animate ? {
