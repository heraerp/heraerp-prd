  ...
  return (
    ...
    >
      ...
      <g transform={`translate(0, ${yOffset})`}>
        ...
        <rect x={letterWidth - strokeWidth} y="0" width={strokeWidth} height={letterHeight} fill={`url(#${gradientId})`} />
        <rect x="0" y={(letterHeight - strokeWidth) / 2} width={letterWidth} height={strokeWidth} fill={`url(#${gradientId})`} />
      </g>
      ...
      <g transform={`translate(${letterWidth + letterSpacing}, ${yOffset})`}>
        ...
        <rect x="0" y={(letterHeight - strokeWidth) / 2} width={letterWidth * 0.8} height={strokeWidth} fill={`url(#${gradientId})`} />
        <rect x="0" y={letterHeight - strokeWidth} width={letterWidth} height={strokeWidth} fill={`url(#${gradientId})`} />
      </g>
      ...
      <g transform={`translate(${(letterWidth + letterSpacing) * 2}, ${yOffset})`}>
        <rect x="0" y="0" width={strokeWidth} height={letterHeight} fill={`url(#${gradientId})`} />
        <rect x="0" y="0" width={letterWidth} height={strokeWidth} fill={`url(#${gradientId})`} />
        <rect x={letterWidth - strokeWidth} y="0" width={strokeWidth} height={letterHeight / 2} fill={`url(#${gradientId})`} />
        <rect x="0" y={(letterHeight - strokeWidth) / 2} width={letterWidth} height={strokeWidth} fill={`url(#${gradientId})`} />
        <path 
      ...
      <g transform={`translate(${(letterWidth + letterSpacing) * 3}, ${yOffset})`}>
        <path 
          ...
          strokeLinecap="square"
        />
        <rect x={letterWidth * 0.2} y={letterHeight * 0.6} width={letterWidth * 0.6} height={strokeWidth} fill={`url(#${gradientId})`} />
      </g>
    </svg>
  )
}
