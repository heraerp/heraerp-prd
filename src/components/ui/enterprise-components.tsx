...
import { CheckCircle, Clock, XCircle, AlertCircle, Info, LucideIcon } from 'lucide-react'
...
export function EnterpriseStatCard({
  ...
  return (
    <Card
      className={cn('bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700', className)}
    >
...
export function EnterpriseInfoCard({
  ...
  const gradientMap = {
    ...
    warning:
      'from-amber-50 to-orange-50 dark:from-gray-800 dark:to-gray-900 border-amber-200 dark:border-amber-800',
    success:
      'from-emerald-50 to-green-50 dark:from-gray-800 dark:to-gray-900 border-emerald-200 dark:border-emerald-800',
    error:
      'from-red-50 to-pink-50 dark:from-gray-800 dark:to-gray-900 border-red-200 dark:border-red-800'
  }
  ...
  return (
    <Card className={cn('bg-gradient-to-br', gradientMap[type], className)}>
      <CardHeader>
...
export function EnterpriseButton({
  ...
  return (
    <Button
      ...
      className={cn(variantClasses[variant], sizeClasses[size], 'font-semibold', className)}
    >
...
export function EnterpriseTitle({
  children,
  className
}: {
  children: ReactNode
...
export function EnterpriseSubtitle({
  children,
  className
}: {
  children: ReactNode
