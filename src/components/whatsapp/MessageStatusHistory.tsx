...
export function MessageStatusHistory({
  ...
  const displayHistory = statusHistory.length > 0 ? statusHistory : [
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3">
            ...
            <div className="space-y-1 text-xs text-blue-700 dark:text-blue-400">
              <p>• <strong>Sent:</strong> Message sent to WhatsApp servers</p>
              <p>• <strong>Delivered:</strong> Message delivered to recipient's device</p>
              <p>• <strong>Read:</strong> Recipient has read the message</p>
              <p>• <strong>Failed:</strong> Message delivery failed</p>
            </div>
          </div>
        </div>
      </DialogContent>
