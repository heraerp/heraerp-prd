  ...
  return (
    <div className="min-h-screen bg-[#393939]">
      ...
      >
        ...
        <div className="relative flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
          ...
          <div className="flex items-center px-4 mb-8">
            ...
            {isExpanded && (
              <div className="ml-3">
                <h2 className="text-lg font-bold text-white">CRM Pro</h2>
                <p className="text-xs text-white/60">Sales Excellence</p>
              </div>
            )}
          </div>
              ...
              return (
                <Link
                  ...
                  className={`group flex items-center px-2 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 ${
                    isActive
                      ? 'bg-gradient-to-r from-[#FF5A09]/20 to-[#ec7f37]/20 text-white border border-[#FF5A09]/30'
      ...
      <div className={`lg:hidden fixed inset-0 z-40 ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex flex-col w-64 bg-gradient-to-b from-[#FF5A09]/20 via-[#ec7f37]/10 to-[#be4f0c]/20 backdrop-blur-xl border-r border-white/10">
