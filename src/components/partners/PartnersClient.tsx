      ...
      {stats.map((stat, idx) => (
        <div key={idx} className="relative group">
          ...
          <div className="relative bg-card border border-border p-6 rounded-2xl text-center shadow-sm">
            <div className="!text-gray-900 dark:!text-gray-100 text-3xl font-bold mb-1">
              {stat.value}
            </div>
...
function PartnerBenefits() {
  ...
  return (
    <div className="mb-12">
      <h2 className="!text-gray-900 dark:!text-gray-100 text-2xl font-semibold text-center mb-8">
      ...
      <div className="flex-grow flex flex-col">
        ...
        {partner.specialties && partner.specialties.length > 0 && (
          <div className="flex flex-wrap gap-1 mb-4">
            {partner.specialties.slice(0, 3).map((specialty, idx) => (
              <span
                key={idx}
                className="inline-block px-2 py-1 bg-indigo-100 dark:bg-indigo-900/30 !text-indigo-700 dark:!text-indigo-300 text-xs rounded"
              >
                {specialty}
              </span>
            ))}
        ...
        {partner.locations && (
          <div className="flex items-center gap-2 text-xs !text-gray-500 dark:!text-gray-400 mb-4">
            ...
            <span>
              {(partner.locations as any)?.hq ||
                ((partner.locations as any)?.regions && (partner.locations as any).regions[0]) ||
                'Global'}
            </span>
          </div>
        )}
  ...
  const filtered = useMemo(() => {
    return partners.filter(partner => {
      ...
      if (region !== 'All') {
        ...
        const partnerRegion =
          partnerLocation?.hq ||
          (partnerLocation?.regions && partnerLocation.regions[0]) ||
          'Global'
    ...
    <main className="w-full">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="!text-gray-600 dark:!text-gray-300 text-lg md:text-xl max-w-3xl mx-auto mb-8 leading-relaxed">
              ...
              Early partners shape the future of ERP implementation and gain first-mover advantages
              in their markets.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="/partners/apply"
                className="px-8 py-3 text-lg rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                Become a Partner
              </Link>
              <Link
                href="/book-a-meeting"
                className="px-8 py-3 text-lg rounded-xl border border-border !text-gray-900 dark:!text-gray-100 font-semibold hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-300"
              >
                Partner Demo
              </Link>
            </div>
      ...
      <section className="py-12 space-y-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-500/5 via-purple-500/5 to-cyan-500/5 p-[1px]">
                <div className="relative bg-card rounded-2xl p-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div>
                      <h3 className="!text-gray-900 dark:!text-gray-100 text-2xl font-bold mb-3">
                        {featuredPartner.name}
                      </h3>
                      <p className="!text-gray-600 dark:!text-gray-300 mb-4 leading-relaxed">
                        {featuredPartner.summary ||
                          "As a founding partner, this firm has exclusive access to HERA's revolutionary platform, priority support, and the opportunity to shape our product roadmap."}
                      </p>
                      <div className="flex flex-wrap gap-2 mb-4">
                        {featuredPartner.specialties?.slice(0, 3).map((specialty, idx) => (
                          <span
                            key={idx}
                            className="px-3 py-1 rounded-lg bg-indigo-100 dark:bg-indigo-900/30 !text-indigo-700 dark:!text-indigo-300 text-sm"
                          >
                            {specialty}
                          </span>
                        ))}
            ...
            <div className="text-center py-16">
              <div className="max-w-md mx-auto">
                <div className="bg-card p-12 rounded-2xl border border-border shadow-sm">
                  ...
                  <h3 className="!text-gray-900 dark:!text-gray-100 text-xl font-semibold mb-3">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Link
                      href="/partners/apply"
                      className="px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl"
                    >
                      Become a Partner
                    </Link>
                  </div>
        ...
        <div className="mt-16 p-8 rounded-2xl bg-gradient-to-r from-slate-50 to-gray-50 dark:from-slate-900/50 dark:to-gray-900/50 border border-border shadow-sm">
          <h3 className="!text-gray-900 dark:!text-gray-100 text-2xl font-semibold text-center mb-8">
            Partnership Journey
          </h3>
        ...
        <div className="mt-16 border-t border-border pt-12">
          <div className="text-center mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-4 max-w-3xl mx-auto mb-8">
              <div className="bg-card p-4 rounded-xl border border-border shadow-sm">
                ...
                <div className="!text-gray-600 dark:!text-gray-300 text-xs">
                  First partners get regional exclusivity
                </div>
              </div>
              <div className="bg-card p-4 rounded-xl border border-border shadow-sm">
                <div className="text-2xl mb-2">💎</div>
                ...
                <div className="!text-gray-600 dark:!text-gray-300 text-xs">
                  Direct access to HERA leadership
                </div>
              </div>
              <div className="bg-card p-4 rounded-xl border border-border shadow-sm">
                <div className="text-2xl mb-2">🚀</div>
                ...
                <div className="!text-gray-600 dark:!text-gray-300 text-xs">
                  Be first to market with HERA ERP
                </div>
              </div>
            </div>
            ...
            <div className="inline-flex flex-col items-center gap-4 px-8 py-6 rounded-2xl bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-cyan-500/10 border border-indigo-500/20 shadow-sm">
              <div className="flex items-center gap-2">
                ...
                <div className="text-left">
                  <div className="!text-gray-900 dark:!text-gray-100 text-lg font-bold">
                    Limited Founding Partner Positions
                  </div>
              ...
              <Link
                href="/partners/apply"
                className="px-8 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
