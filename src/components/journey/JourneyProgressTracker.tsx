    ...
    <div className="w-full px-4 py-6 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="mt-2">
                  ...
                  <p className={cn(
                    ...
                    step.status === 'current' ? "text-gray-600 dark:text-gray-300" : "text-gray-500 dark:text-gray-400"
                  )}>
                    {step.subtitle}
                  </p>
                </div>
      ...
      <div className="mt-6 sm:hidden">
        <div className="flex items-center justify-center gap-2 text-sm">
          <span className="text-gray-500">Step {steps.findIndex(s => s.status === 'current') + 1} of {steps.length}:</span>
