...
import type { CaseFilters, CaseFilterBarProps, CaseStatus, CasePriority, CaseRag } from '@/types/cases';
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap gap-4">
        ...
        <Select
          ...
          onValueChange={(value) => handleStatusChange(value === 'all' ? [] : value.split(',') as CaseStatus[])}
        >
