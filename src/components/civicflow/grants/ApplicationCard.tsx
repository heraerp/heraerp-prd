        ...
        <div className="space-y-3 flex-1">
          ...
          {application.score !== undefined && (
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-text-100 font-medium">{application.score}/100</span>
            </div>
          )}
          ...
          {application.last_action_at && (
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-text-100">{formatDate(application.last_action_at)}</span>
            </div>
          )}
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-text-100">{formatDate(application.created_at)}</span>
          </div>
        </div>

        {/* Actions */}
        <div className="flex gap-2 mt-4 pt-4 border-t border-border">
          <Button variant="outline" size="sm" className="flex-1 border-border hover:bg-accent-soft">
