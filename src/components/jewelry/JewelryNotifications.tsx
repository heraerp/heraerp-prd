...
export function JewelryNotifications() {
  ...
  const getNotificationColor = (type: string) => {
    switch (type) {
      case 'appraisal': return 'border-l-yellow-500 bg-yellow-500/5'
      case 'vip': return 'border-l-purple-500 bg-purple-500/5'
      case 'inventory': return 'border-l-blue-500 bg-blue-500/5'
      case 'appointment': return 'border-l-green-500 bg-green-500/5'
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm jewelry-text-muted mt-1">
                            {notification.message}
                          </p>
                          <p className="text-xs jewelry-text-muted mt-2">
                            {notification.time}
                          </p>
                        </div>
                      </div>
