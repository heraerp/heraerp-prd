...
import { 
  ArrowLeft, 
  Home, 
  Calendar, Users, CreditCard, Pill, FileText
} from 'lucide-react'

export function HealthcarePracticeSidebar() {
  const router = useRouter()

  const sidebarItems = [
    { id: 'back', icon: ArrowLeft, label: 'Back to Dashboard', action: () => router.push('/dashboard'), isBack: true },
    { id: 'home', icon: Home, label: 'Healthcare Practice Home', action: () => router.push('/healthcare-progressive'), isActive: true },
  ...
  return (
    <aside className="w-20 bg-gradient-to-b from-blue-500 to-cyan-600 flex flex-col">
