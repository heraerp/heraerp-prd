...
export default function DocContent({ 
  ...
  useEffect(() => {
    ...
    codeBlocks.forEach((block) => {
      ...
      copyButton.className = 'copy-button absolute top-2 right-2 px-2 py-1 text-xs bg-background border rounded hover:bg-accent transition-colors'
    ...
    headings.forEach((heading) => {
      ...
      link.className = 'heading-link opacity-0 group-hover:opacity-100 ml-2 text-muted-foreground hover:text-hera-primary transition-opacity'
