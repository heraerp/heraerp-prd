      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <Tabs value={timeframe} onValueChange={(v: any) => setTimeframe(v)}>
          <TabsList className="bg-slate-800/50 border-slate-700">
            ...
            <TabsTrigger value="1W" className="data-[state=active]:bg-slate-700">1W</TabsTrigger>
            <TabsTrigger value="1M" className="data-[state=active]:bg-slate-700">1M</TabsTrigger>
            <TabsTrigger value="3M" className="data-[state=active]:bg-slate-700">3M</TabsTrigger>
            <TabsTrigger value="1Y" className="data-[state=active]:bg-slate-700">1Y</TabsTrigger>
