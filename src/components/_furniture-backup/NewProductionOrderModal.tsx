...
} return ( <Dialog open={open} onOpenChange={onClose}> <DialogContent className="max-w-2xl bg-[var(--color-body)] border-[var(--color-border)] text-[var(--color-text-primary)]"> <DialogHeader> <DialogTitle className="text-xl font-semibold text-[var(--color-text-primary)] flex items-center gap-2"> <Factory className="h-5 w-5 text-[var(--color-icon-secondary)]" /> New Production Order </DialogTitle> </DialogHeader> {error && ( <Alert variant="destructive" className="bg-red-900/20 border-red-800"> <AlertCircle className="h-4 w-4" /> <AlertDescription>{error}</AlertDescription> </Alert> )} <form onSubmit={handleSubmit} className="bg-[var(--color-body)] space-y-6"> {/* Product and Work Center */} <div className="grid grid-cols-2 gap-4"> <div className="space-y-2"> <Label htmlFor="product" className="bg-[var(--color-body)] text-[var(--color-text-secondary)]"> Product to Produce </Label> <Select value={formData.productId} onValueChange={value => setFormData({ ...formData, productId: value })} > <SelectTrigger id="product" className="bg-[var(--color-body)] border-[var(--color-border)] text-[var(--color-text-primary)] hover:bg-accent" > <SelectValue placeholder="Select product" /> </SelectTrigger> <SelectContent className="bg-[var(--color-body)] border-[var(--color-border)] z-[9999]"> {products.map((product: any) => ( <SelectItem key={product.id} value={product.id} className="text-gray-200 hover:bg-[var(--color-sidebar)]/30 focus:bg-muted-foreground/10 focus:text-[var(--color-text-primary)] cursor-pointer" > <div className="flex items-center gap-2"> <Package className="h-4 w-4 text-[var(--color-icon-secondary)]" /> {product.entity_name} </div> </SelectItem> ))} </SelectContent> </Select> </div> <div className="space-y-2"> <Label htmlFor="workcenter" className="bg-[var(--color-body)] text-[var(--color-text-secondary)]"> Work Center </Label> <Select value={formData.workCenterId} onValueChange={value => setFormData({ ...formData, workCenterId: value })} > <SelectTrigger id="workcenter" className="bg-[var(--color-body)] border-[var(--color-border)] text-[var(--color-text-primary)] hover:bg-accent" > <SelectValue placeholder="Select work center" /> </SelectTrigger> <SelectContent className="bg-[var(--color-body)] border-[var(--color-border)] z-[9999]"> {workCenters.map((center: any) => ( <SelectItem key={center.id} value={center.id} className="text-gray-200 hover:bg-[var(--color-sidebar)]/30 focus:bg-muted-foreground/10 focus:text-[var(--color-text-primary)] cursor-pointer" > <div className="flex items-center gap-2"> <Factory className="h-4 w-4 text-[var(--color-icon-secondary)]" /> {center.entity_name} </div> </SelectItem> ))} </SelectContent> </Select> </div> </div> {/* Quantity and Batch */} <div className="grid grid-cols-2 gap-4"> <div className="space-y-2"> <Label htmlFor="quantity" className="bg-[var(--color-body)] text-[var(--color-text-secondary)]"> Planned Quantity </Label> <Input id="quantity" type="number" min="1" value={formData.plannedQuantity} onChange={e => setFormData({ ...formData, plannedQuantity: parseInt(e.target.value) || 1 }  ) className="bg-[var(--color-body)] border-[var(--color-border)] text-[var(--color-text-primary)]" required /> </div> <div className="space-y-2"> <Label htmlFor="batch" className="bg-[var(--color-body)] text-[var(--color-text-secondary)]"> Batch Number </Label> <Input id="batch" value={formData.batchNumber} onChange={e => setFormData({ ...formData, batchNumber: e.target.value })} className="bg-[var(--color-body)] border-[var(--color-border)] text-[var(--color-text-primary)] font-mono" required /> </div> </div> {/* Dates */} <div className="grid grid-cols-2 gap-4"> <div className="space-y-2"> <Label htmlFor="start-date" className="bg-[var(--color-body)] text-[var(--color-text-secondary)]"> Planned Start Date </Label> <div className="relative"> <Input id="start-date" type="date" value={formData.plannedStartDate} onChange={e => setFormData({ ...formData, plannedStartDate: e.target.value })} className="bg-[var(--color-body)] border-[var(--color-border)] text-[var(--color-text-primary)] pl-10" required /> <Calendar className="absolute left-3 top-3 h-4 w-4 text-[var(--color-text-secondary)]" /> </div> </div> <div className="space-y-2"> <Label htmlFor="end-date" className="bg-[var(--color-body)] text-[var(--color-text-secondary)]"> Planned End Date </Label> <div className="relative"> <Input id="end-date" type="date" value={formData.plannedEndDate} onChange={e => setFormData({ ...formData, plannedEndDate: e.target.value })} className="bg-[var(--color-body)] border-[var(--color-border)] text-[var(--color-text-primary)] pl-10" required /> <Calendar className="absolute left-3 top-3 h-4 w-4 text-[var(--color-text-secondary)]" /> </div> </div> </div> {/* Priority */} <div className="space-y-2"> <Label htmlFor="priority" className="bg-[var(--color-body)] text-[var(--color-text-secondary)]"> Priority </Label> <Select value={formData.priority} onValueChange={value => setFormData({ ...formData, priority: value })} > <SelectTrigger id="priority" className="bg-[var(--color-body)] border-[var(--color-border)] text-[var(--color-text-primary)] hover:bg-accent" > <SelectValue /> </SelectTrigger> <SelectContent className="bg-[var(--color-body)] border-[var(--color-border)] z-[9999]"> <SelectItem value="low" className="text-gray-200 hover:bg-[var(--color-sidebar)]/30 focus:bg-muted-foreground/10 focus:text-[var(--color-text-primary)] cursor-pointer" > <div className="flex items-center gap-2"> <Badge className="bg-muted-foreground/20 text-[var(--color-text-secondary)] border-0"> Low </Badge> </div> </SelectItem> <SelectItem value="medium" className="text-gray-200 hover:bg-[var(--color-sidebar)]/30 focus:bg-muted-foreground/10 focus:text-[var(--color-text-primary)] cursor-pointer" > <div className="flex items-center gap-2"> <Badge className="bg-[var(--color-body)]/20 text-[var(--color-text-secondary)] border-0">Medium</Badge> </div> </SelectItem> <SelectItem value="high" className="text-gray-200 hover:bg-[var(--color-sidebar)]/30 focus:bg-muted-foreground/10 focus:text-[var(--color-text-primary)] cursor-pointer" > <div className="bg-[var(--color-body)] flex items-center gap-2"> <Badge className="bg-[var(--color-accent-indigo)]/20 text-[var(--color-text-secondary)] border-0">High</Badge> </div> </SelectItem> <SelectItem value="urgent" className="text-gray-200 hover:bg-[var(--color-sidebar)]/30 focus:bg-muted-foreground/10 focus:text-[var(--color-text-primary)] cursor-pointer" > <div className="bg-[var(--color-body)] flex items-center gap-2"> <Badge className="bg-red-600/20 text-red-400 border-0">Urgent</Badge> </div> </SelectItem> </SelectContent> </Select> </div> {/* Notes */} <div className="space-y-2"> <Label htmlFor="notes" className="bg-[var(--color-body)] text-[var(--color-text-secondary)]"> Production Notes </Label> <Textarea id="notes" value={formData.notes} onChange={e => setFormData({ ...formData, notes: e.target.value })} rows={3} className="bg-[var(--color-body)] border-[var(--color-border)] text-[var(--color-text-primary)] resize-none" placeholder="Special instructions, materials needed, quality requirements..." /> </div> {/* Production Summary */} {formData.productId && ( <div className="p-4 bg-[var(--color-body)]/50 rounded-lg border border-[var(--color-border)]"> <h4 className="bg-[var(--color-body)] text-sm font-medium text-[var(--color-text-secondary)] mb-2">Production Summary</h4> <div className="space-y-1 text-sm"> <div className="bg-[var(--color-body)] flex justify-between"> <span className="text-[var(--color-text-secondary)]">Product:</span> <span className="text-[var(--color-text-primary)] font-medium"> {products.find(p => p.id === formData.productId)?.entity_name} </span> </div> <div className="bg-[var(--color-body)] flex justify-between"> <span className="text-[var(--color-text-secondary)]">Quantity:</span> <span className="text-[var(--color-text-primary)] font-medium"> {formData.plannedQuantity} units </span> </div> <div className="bg-[var(--color-body)] flex justify-between"> <span className="text-[var(--color-text-secondary)]">Duration:</span> <span className="text-[var(--color-text-primary)] font-medium"> {Math.ceil( (new Date(formData.plannedEndDate).getTime() - new Date(formData.plannedStartDate).getTime()) / (1000 * 60 * 60 * 24) )}{' '} days </span> </div> </div> </div> )} {/* Actions */} <div className="bg-[var(--color-body)] flex justify-end gap-3 pt-4 border-t border-[var(--color-border)]"> <Button type="button" variant="outline" onClick={onClose} className="bg-transparent border-[var(--color-border)] text-[var(--color-text-secondary)] hover:bg-[var(--color-body)] hover:text-[var(--color-text-primary)]" > Cancel </Button> <Button type="submit" disabled={loading} className="bg-gradient-to-r from-[var(--color-accent-indigo)] to-[var(--color-accent-teal)] hover:from-[var(--color-accent-indigo)] hover:to-[var(--color-accent-teal)] text-[var(--color-text-primary)] border-0" > {loading ? ( <> <div className="bg-[var(--color-body)] animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2" /> Creating... </> ) : ( <> <Plus className="h-4 w-4 mr-2" /> Create Production Order </> )} </Button> </div> </form> </DialogContent> </Dialog> )
}
