  ...
  return (
    <div className="bg-[var(--color-body)] space-y-6">
      ...
      <Card className="bg-[var(--color-surface-raised)] border-[var(--color-border)] p-4 bg-[var(--color-body)]/50 border-[var(--color-border)]">
        {' '}
        <div className="bg-[var(--color-body)] flex gap-4">
          {' '}
            ...
            >
              ...
              <div className="grid grid-cols-8 gap-4 items-center">
                ...
                <div className="flex items-center gap-2">
                  {' '}
                  <Skeleton className="h-4 w-4" /> <Skeleton className="h-5 w-32" />{' '}
                </div>{' '}
                <Skeleton className="h-6 w-20 rounded-full" /> <Skeleton className="h-5 w-16" />{' '}
