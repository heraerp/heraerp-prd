...
interface FurnitureDarkThemeProviderProps {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (savedOriginalTheme) {
        localStorage.setItem('hera-theme', savedOriginalTheme)
        sessionStorage.removeItem('furniture-original-theme')
      }
    }
  }, [])

  // Also handle any system theme changes and force dark mode
  useEffect(() => {
