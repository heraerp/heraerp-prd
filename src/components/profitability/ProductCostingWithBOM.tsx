...
import { 
  Package, Layers, Calculator, TrendingUp, DollarSign,
  ChevronRight, ChevronDown, RefreshCw, AlertTriangle,
  CheckCircle, Zap, GitBranch, FileText, Activity
} from 'lucide-react'
    ...
    try {
      ...
      if (data.success) {
        ...
        setSelectedProduct({
          ...
          selling_price: 250.00, // Mock selling price
          gross_margin: 250.00 - data.total_cost,
          gross_margin_pct: ((250.00 - data.total_cost) / 250.00) * 100,
          last_updated: data.calculation_date
        })
        
        // Set BOM components
        setBomComponents(data.cost_breakdown.direct_material.components.map((comp: any, idx: number) => ({
          id: `comp_${idx}`,
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Product costing with BOM integration
                </CardDescription>
              </div>
        ...
        <TabsContent value="breakdown" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Click sections to view detailed components
              </CardDescription>
            </CardHeader>
                      ...
                      <div className="space-y-2">
                        {category.details.map((detail: any, idx: number) => (
                          <div key={idx} className="flex items-center justify-between text-sm">
                            <div className="flex items-center gap-2">
                              {category.category === 'Direct Material' && <Package className="w-4 h-4 text-blue-500" />}
                              {category.category === 'Direct Labor' && <Activity className="w-4 h-4 text-green-500" />}
                              {category.category === 'Manufacturing Overhead' && <GitBranch className="w-4 h-4 text-purple-500" />}
        ...
        <TabsContent value="bom" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Hierarchical view of product components with costs
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-2">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-yellow-700 mt-1">
                      Raw Material A cost increased 8.5% compared to standard. Consider reviewing supplier contracts.
                    </p>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-green-700 mt-1">
                      Switching to batch production could reduce setup costs by 22% for this product line.
                    </p>
                    <div className="flex items-center gap-2 mt-2">
                      <Badge variant="outline" className="text-xs">
                        HERA.PROF.AI.OPT.v1
