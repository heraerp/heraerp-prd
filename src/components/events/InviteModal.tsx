...
export function InviteModal({ open, onOpenChange, eventId, eventName }: InviteModalProps) {
  ...
  const subjects = subjectType === 'constituent' ? constituentsData?.items : organizationsData?.items;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh]">
        ...
        <div className="space-y-4">
          ...
          <Tabs value={subjectType} onValueChange={(v) => setSubjectType(v as 'constituent' | 'organization')}>
