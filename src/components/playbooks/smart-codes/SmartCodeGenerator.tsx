...
function SmartCodeValidatorTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      {validation && (
        <ValidationDisplay validation={validation} showComponents />
      )}
  ...
  return (
    <div className="space-y-4">
      <Alert>
        ...
        <AlertDescription>
          Click any template to use it as a starting point. Replace variables in {'{}'} with your values.
        </AlertDescription>
      </Alert>
      ...
      {showComponents && validation.components && (
        <div className="bg-gray-50 p-3 rounded-lg">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div><span className="text-gray-600">Prefix:</span> {validation.components.prefix}</div>
            <div><span className="text-gray-600">Industry:</span> {validation.components.industry}</div>
            <div><span className="text-gray-600">Module:</span> {validation.components.module}</div>
            <div><span className="text-gray-600">Type:</span> {validation.components.type}</div>
            <div><span className="text-gray-600">Subtype:</span> {validation.components.subtype}</div>
            <div><span className="text-gray-600">Version:</span> {validation.components.version}</div>
          </div>
        </div>
      )}
