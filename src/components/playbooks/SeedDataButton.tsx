      ...
      if (!response.ok) {
        ...
        if (data.error && data.error.includes('Service role key')) {
          toast({
            ...
            description:
              'Please add SUPABASE_SERVICE_ROLE_KEY to your .env file. You can find this in your Supabase project settings under API.',
            variant: 'destructive'
          })
          return
        }
      ...
      <AlertDialog open={showClearDialog} onOpenChange={setShowClearDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete all playbooks in the CivicFlow demo organization. This
