...
import { useUpdatePlaybookStatus, useDuplicatePlaybook, useDeletePlaybook } from '@/hooks/use-playbooks';
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete this playbook and all its associated data. 
