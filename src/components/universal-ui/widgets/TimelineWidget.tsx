          ...
          <div className="animate-pulse space-y-4">
            {[1, 2, 3].map(i => (
              <div key={i} className="flex gap-4">
                <div className="h-8 w-8 bg-gray-200 dark:bg-muted-foreground/10 rounded-full"></div>
                <div className="flex-1 space-y-2">
                  <div className="h-4 bg-gray-200 dark:bg-muted-foreground/10 rounded w-1/3"></div>
                  <div className="h-3 bg-gray-200 dark:bg-muted-foreground/10 rounded w-2/3"></div>
                </div>
              </div>
            ))}
          </div>
