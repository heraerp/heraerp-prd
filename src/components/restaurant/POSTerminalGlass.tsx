...
export function POSTerminalGlass({ 
  ...
  const generateDemoMenuItems = (): MenuItem[] => [
    // Appetizers
    { id: '1', entity_name: 'Bruschetta', entity_code: 'APP-001', metadata: { category: 'Appetizers', price: 8.50, description: 'Toasted bread with tomatoes and basil', available: true, preparation_time: 10, image_url: 'https://images.unsplash.com/photo-1572695157366-5e585ab2b69f?w=400', rating: 4.5, popular: true } },
    { id: '2', entity_name: 'Calamari Fritti', entity_code: 'APP-002', metadata: { category: 'Appetizers', price: 12.50, description: 'Crispy fried calamari with marinara', available: true, preparation_time: 15, image_url: 'https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?w=400', rating: 4.7 } },
    { id: '3', entity_name: 'Garlic Bread', entity_code: 'APP-003', metadata: { category: 'Appetizers', price: 6.50, description: 'Fresh baked with garlic butter', available: true, preparation_time: 8, image_url: 'https://images.unsplash.com/photo-1619531040576-f9416aeaec92?w=400', rating: 4.3 } },
    
    // Salads
    { id: '4', entity_name: 'Caesar Salad', entity_code: 'SAL-001', metadata: { category: 'Salads', price: 11.00, description: 'Romaine, parmesan, croutons', available: true, modifiers: ['Add Chicken +$5', 'Add Shrimp +$8'], preparation_time: 10, image_url: 'https://images.unsplash.com/photo-1550304943-4f24f54ddde9?w=400', rating: 4.6 } },
    { id: '5', entity_name: 'Caprese Salad', entity_code: 'SAL-002', metadata: { category: 'Salads', price: 12.00, description: 'Fresh mozzarella, tomatoes, basil', available: true, preparation_time: 10, image_url: 'https://images.unsplash.com/photo-1608032077018-c9aaa7c7b9dc?w=400', rating: 4.8, popular: true } },
    
    // Pizza
    { id: '6', entity_name: 'Margherita Pizza', entity_code: 'PIZ-001', metadata: { category: 'Pizza', price: 16.00, description: 'Fresh mozzarella, tomato, basil', available: true, modifiers: ['Small -$3', 'Large +$4', 'Extra Cheese +$2'], preparation_time: 20, image_url: 'https://images.unsplash.com/photo-1604068549290-dea0e4a305ca?w=400', rating: 4.9, popular: true } },
    { id: '7', entity_name: 'Pepperoni Pizza', entity_code: 'PIZ-002', metadata: { category: 'Pizza', price: 18.00, description: 'Mozzarella, pepperoni, tomato sauce', available: true, modifiers: ['Small -$3', 'Large +$4', 'Extra Cheese +$2'], preparation_time: 20, image_url: 'https://images.unsplash.com/photo-1628840042765-356cda07504e?w=400', rating: 4.7 } },
    { id: '8', entity_name: 'Quattro Formaggi', entity_code: 'PIZ-003', metadata: { category: 'Pizza', price: 19.00, description: 'Four cheese blend', available: true, modifiers: ['Small -$3', 'Large +$4'], preparation_time: 20, image_url: 'https://images.unsplash.com/photo-1571407970349-bc81e7e96d47?w=400', rating: 4.6 } },
    
    // Pasta
    { id: '9', entity_name: 'Spaghetti Carbonara', entity_code: 'PAS-001', metadata: { category: 'Pasta', price: 15.00, description: 'Egg, pancetta, parmesan', available: true, preparation_time: 15, image_url: 'https://images.unsplash.com/photo-1612874742237-6526221588e3?w=400', rating: 4.8, popular: true } },
    { id: '10', entity_name: 'Penne Arrabbiata', entity_code: 'PAS-002', metadata: { category: 'Pasta', price: 13.00, description: 'Spicy tomato sauce', available: true, modifiers: ['Extra Spicy', 'Add Sausage +$4'], preparation_time: 15, image_url: 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=400', rating: 4.5 } },
    { id: '11', entity_name: 'Fettuccine Alfredo', entity_code: 'PAS-003', metadata: { category: 'Pasta', price: 14.00, description: 'Cream sauce with parmesan', available: true, modifiers: ['Add Chicken +$5', 'Add Shrimp +$8'], preparation_time: 15, image_url: 'https://images.unsplash.com/photo-1645112411341-6c4fd023714a?w=400', rating: 4.6 } },
    
    // Main Course
    { id: '12', entity_name: 'Grilled Salmon', entity_code: 'MAIN-001', metadata: { category: 'Main Course', price: 26.00, description: 'With lemon butter sauce', available: true, preparation_time: 25, image_url: 'https://images.unsplash.com/photo-1485921325833-c519f76c4927?w=400', rating: 4.9, popular: true } },
    { id: '13', entity_name: 'Chicken Parmigiana', entity_code: 'MAIN-002', metadata: { category: 'Main Course', price: 22.00, description: 'Breaded chicken with marinara', available: true, preparation_time: 20, image_url: 'https://images.unsplash.com/photo-1632778149955-e80f8ceca2e8?w=400', rating: 4.7 } },
    { id: '14', entity_name: 'Osso Buco', entity_code: 'MAIN-003', metadata: { category: 'Main Course', price: 32.00, description: 'Braised veal shanks', available: true, preparation_time: 30, image_url: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=400', rating: 4.8 } },
    
    // Desserts
    { id: '15', entity_name: 'Tiramisu', entity_code: 'DES-001', metadata: { category: 'Desserts', price: 8.00, description: 'Classic Italian dessert', available: true, preparation_time: 5, image_url: 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=400', rating: 4.9, popular: true } },
    { id: '16', entity_name: 'Panna Cotta', entity_code: 'DES-002', metadata: { category: 'Desserts', price: 7.00, description: 'With berry sauce', available: true, preparation_time: 5, image_url: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400', rating: 4.6 } },
    { id: '17', entity_name: 'Gelato', entity_code: 'DES-003', metadata: { category: 'Desserts', price: 6.00, description: 'Choice of flavors', available: true, modifiers: ['Vanilla', 'Chocolate', 'Pistachio', 'Strawberry'], preparation_time: 2, image_url: 'https://images.unsplash.com/photo-1567206563064-6f60f40a2b57?w=400', rating: 4.7 } },
    
    // Beverages
    { id: '18', entity_name: 'Soft Drinks', entity_code: 'BEV-001', metadata: { category: 'Beverages', price: 3.50, description: 'Coke, Sprite, Orange', available: true, preparation_time: 1, image_url: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=400', rating: 4.2 } },
    { id: '19', entity_name: 'Italian Soda', entity_code: 'BEV-002', metadata: { category: 'Beverages', price: 4.50, description: 'Various flavors', available: true, preparation_time: 2, image_url: 'https://images.unsplash.com/photo-1534353473418-4cfa6c56fd38?w=400', rating: 4.5 } },
    { id: '20', entity_name: 'Espresso', entity_code: 'BEV-003', metadata: { category: 'Beverages', price: 3.00, description: 'Double shot', available: true, preparation_time: 2, image_url: 'https://images.unsplash.com/photo-1510707577719-ae7c14805e3a?w=400', rating: 4.8 } },
    { id: '21', entity_name: 'Cappuccino', entity_code: 'BEV-004', metadata: { category: 'Beverages', price: 4.50, description: 'With steamed milk', available: true, preparation_time: 3, image_url: 'https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=400', rating: 4.7 } }
  ]
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                className={viewMode === 'list' ? 'bg-white/20 text-white' : 'text-white/70 hover:text-white hover:bg-white/10'}
              >
        ...
        <div className="p-4 border-b border-white/20">
          ...
          <div className="grid grid-cols-3 gap-2">
            <Button
              ...
              className={orderType === 'dine-in' ? 'bg-white/20 text-white border-0' : 'text-white/70 hover:text-white hover:bg-white/10'}
            >
            ...
            <Button
              ...
              className={orderType === 'takeout' ? 'bg-white/20 text-white border-0' : 'text-white/70 hover:text-white hover:bg-white/10'}
            >
            ...
            <Button
              ...
              className={orderType === 'delivery' ? 'bg-white/20 text-white border-0' : 'text-white/70 hover:text-white hover:bg-white/10'}
            >
        ...
        <ScrollArea className="flex-1 p-4">
          ...
          {cart.length === 0 ? (
            ...
            <div className="space-y-3">
              {cart.map((item) => (
                <div key={item.menuItem.id} className="backdrop-blur-sm bg-white/5 rounded-lg p-3 border border-white/10">
              ...
              <div className="grid grid-cols-4 gap-2">
                {[5, 10, 15, 20].map(percent => (
                  <Button
                    ...
                    className={discountPercent === percent 
                ...
                {cashAmount > 0 && (
                  <div className="p-4 bg-slate-800 rounded-lg border border-slate-700">
                    <div className="flex justify-between items-center">
                      ...
                      <span className={`text-2xl font-bold ${change >= 0 ? 'text-emerald-400' : 'text-rose-400'}`}>
