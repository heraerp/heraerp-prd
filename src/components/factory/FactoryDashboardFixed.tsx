            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-background dark:bg-muted border border-border dark:border-border rounded-md px-4 py-2 pr-8 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
                >
