...
from '@/src/types/hera-database.types' const DEMO_CREDENTIALS = { email: 'demo@keralafurniture.com', password: 'FurnitureDemo2025!', organizationId: 'f0af4ced-9d12-4a55-a649-b484368db249'
}
