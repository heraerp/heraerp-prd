...
const ruleTypeConfig = {
  validation: { icon: Shield, color: 'text-blue-500', bgColor: 'bg-blue-500/20' },
  pricing: { icon: DollarSign, color: 'text-green-500', bgColor: 'bg-green-500/20' },
