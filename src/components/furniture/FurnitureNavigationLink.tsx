  ...
  return (
    <NavigationLink
      ...
      className={cn(
        ...
        'text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] hover:bg-[var(--color-sidebar)]/30/50'
      )}
      activeClassName="!bg-gradient-to-r from-[var(--color-accent-indigo)]/20 to-[var(--color-accent-teal)]/20 !text-[var(--color-text-primary)]"
    >
