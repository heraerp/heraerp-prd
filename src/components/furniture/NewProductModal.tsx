  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const productResponse = await universalApi.createEntity({
        ...
        smart_code: `HERA.FURNITURE.PRODUCT.${productData.category.toUpperCase()}.v1`,
      ...
      if (productResponse.success) {
        ...
        const dynamicFields = [
          ...
          { field_name: 'tags', field_value_json: JSON.stringify(productData.tags) },
        ...
        if (productData.stockQuantity > 0) {
          await universalApi.createTransaction({
            ...
            total_amount: productData.stockQuantity * productData.costPrice,
            smart_code: 'HERA.FURNITURE.INVENTORY.INITIAL.v1',
            metadata: {
              adjustment_type: 'initial_stock',
              quantity: productData.stockQuantity,
              unit_cost: productData.costPrice,
