      ...
      <Card>
        ...
        <CardContent className="space-y-6">
                    ...
                    <TableRow key={index}>
                      ...
                      <TableCell>
                        <Input
                          ...
                          onChange={e =>
                            updateLineItem(index, 'unit_amount', parseFloat(e.target.value))
                          }
                        />
                      </TableCell>
                      <TableCell>{(item.quantity * item.unit_amount).toFixed(2)}</TableCell>
                      <TableCell>
                        <Button
                          type="button"
                          variant="ghost"
                    ...
                    <div className="flex justify-between text-sm text-green-600">
                      ...
                      <span>
                        ...
                        {pricingSummary.lineItems
                          .reduce((sum, item) => sum + (item.discount_amount || 0), 0)
                          .toFixed(2)}
                      </span>
                    </div>
                  )}
          ...
          {approvalRequired?.required && (
            <Alert>
              ...
              <AlertDescription>
                ...
                <br />
                This order exceeds AED {approvalRequired.threshold} and requires approval from:{' '}
                {approvalRequired.approvers?.join(', ')}
              </AlertDescription>
            </Alert>
          )}
          ...
          <div className="flex justify-between">
            <div className="text-lg font-semibold">Total: AED {calculateTotal().toFixed(2)}</div>
