...
export function ManufacturingOrderDashboard() {
    ...
    try {
      ...
      for (const order of ordersData.data || []) {
        ...
        formattedOrders.push({
          ...
          product_id: order.reference_entity_id,
          product_name: product?.entity_name || 'Unknown Product',
          quantity_to_produce: quantityToProduced,
  ...
  const updateOrderStatus = async (orderId: string, newStatus: string) => {
    try {
      // In a real implementation, this would update the order status via API
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{productionStatus.total}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{productionStatus.completed}</div>
            <p className="text-xs text-muted-foreground mt-1">
                      ...
                      <TableRow key={order.id}>
                        ...
                        <TableCell>
                          <span className="text-sm font-medium">
                            {order.progress_percent.toFixed(0)}%
                          </span>
                        </TableCell>
                        <TableCell>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              Order Details: {selectedOrder.transaction_code}
            </CardTitle>
          </CardHeader>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="font-medium">
                  {selectedOrder.quantity_completed} / {selectedOrder.quantity_to_produce}
                </p>
              </div>
              <div>
            ...
            <div className="pt-4 border-t">
              ...
              <div className="space-y-2">
                ...
                {selectedOrder.status === 'completed' && (
                  <div className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 text-green-600" />
                    <span className="text-sm">Production Completed</span>
                  </div>
                )}
              </div>
            </div>
