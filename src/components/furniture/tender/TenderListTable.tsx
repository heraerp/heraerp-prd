...
// Filter tenders based on search and status
  ...
  return (
    <div className="bg-[var(--color-body)] space-y-4">
      ...
      {/* Tender List Table */}
      <Card className="bg-[var(--color-surface-raised)] border-[var(--color-border)] bg-[var(--color-body)]/70 backdrop-blur-sm border-[var(--color-border)]/50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="bg-[var(--color-surface-raised)] border-[var(--color-border)] p-4 bg-[var(--color-body)]/70 backdrop-blur-sm border-[var(--color-border)]/50">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-[var(--color-text-secondary)]">Active Tenders</p>
        ...
        <Card className="bg-[var(--color-surface-raised)] border-[var(--color-border)] p-4 bg-[var(--color-body)]/70 backdrop-blur-sm border-[var(--color-border)]/50">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl font-bold text-[var(--color-text-primary)]">₹2.1Cr</p>
            </div>
