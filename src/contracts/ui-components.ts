...
export const BaseModalPropsSchema = z.object({
  isOpen: z.boolean(),
...
export const ApplicationCardPropsSchema = z.object({
...
export const ProgramCardPropsSchema = z.object({
...
export const LoadingStatePropsSchema = z.object({
  isLoading: z.boolean(),
