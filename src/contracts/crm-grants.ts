...
export const GrantRoundStatusSchema = z.enum([
  'draft',
  'open',
  'closed',
  'awarded',
...
export const GrantScoringSchema = z.object({
...
export const CreateGrantApplicationRequestSchema = z.object({
  applicant: ApplicantSchema,
...
// Grant KPIs Schema
export const GrantKpisSchema = z.object({
...
export const ExportGrantsRequestSchema = z.object({
...
// Paginated Responses
export const PaginatedGrantApplicationsSchema = PaginatedResponseSchema(GrantApplicationWithRelatedSchema);
...
export const validateGrantFilters = (data: unknown): GrantFilters =>
  GrantFiltersSchema.parse(data);
