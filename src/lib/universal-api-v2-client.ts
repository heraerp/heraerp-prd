...
export async function setDynamicData(orgId: string, body: {
  p_entity_id: string;
  p_field_name: string;
...
export async function createTransaction(orgId: string, body: {
...
export async function createRelationship(orgId: string, body: {
