              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-xs font-mono">HERA.CRM.CUST.ENT.PROF.v1</td>
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-xs font-mono">HERA.FIN.INV.TXN.SALE.v1</td>
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-xs font-mono">HERA.INV.PROD.ENT.ITEM.v1</td>
...
export default function DashboardPage() {
  ...
  const customMessages = {
    ...
    'ui.onboard.widget.kpi.intro.body': 'These cards show your key performance indicators at a glance. Click any card to drill down into details.',
  };
