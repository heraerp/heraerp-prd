...
export const generateCSSVariables = (
  ...
  customizations?: ThemeConfiguration['customizations']
) => {
  ...
  return {
    ...
    // Customizations
    '--border-radius':
      customizations?.borderRadius === 'none'
        ? '0'
        : customizations?.borderRadius === 'sm'
          ? '0.125rem'
          : customizations?.borderRadius === 'md'
            ? '0.375rem'
            : customizations?.borderRadius === 'lg'
              ? '0.5rem'
              : customizations?.borderRadius === 'xl'
                ? '0.75rem'
                : '0.375rem',

    '--shadow-color': main[900],
    '--shadow-opacity':
      customizations?.shadows === 'none'
        ? '0'
        : customizations?.shadows === 'sm'
          ? '0.1'
          : customizations?.shadows === 'md'
            ? '0.15'
            : customizations?.shadows === 'lg'
              ? '0.2'
              : customizations?.shadows === 'xl'
                ? '0.25'
                : '0.15'
  }
}
