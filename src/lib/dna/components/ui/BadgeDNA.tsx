...
export function BadgeDNA({ children, variant = 'default', icon: Icon, className }: BadgeDNAProps) {
  return (
    <Badge className={cn('gap-1 font-medium border', variantStyles[variant], className)}>
