...
// ================================================================================
// HERA DNA UI - CLIENT-ONLY BARREL EXPORT
// Smart Code: HERA.DNA.UI.BARREL.CLIENT.V1
// Re-export ONLY client components from here to prevent SSR issues
// ================================================================================
...
export { ScrollAreaDNA } from './ScrollAreaDNA';
