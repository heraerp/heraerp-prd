...
export function SalonLuxeCRUDPage({
  ...
  const canEdit = editPermissions.some(p => 
    p.includes(':') ? hasPermission(p) : salonRole === p
  )
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium" style={{ color: LUXE_COLORS.bronze }}>
                    {sortedItems.length} {title.toLowerCase()} • {description || `Manage your ${title.toLowerCase()}`}
                  </p>
                </div>
              </div>
            </div>
              ...
              {CustomFormComponent ? (
                ...
                <EntityForm
                  ...
                  initialData={editingItem ? {
                    ...
                    smart_code: editingItem.smart_code || preset.smart_code || `HERA.SALON.${entityType}.ENTITY.v1`,
                    dynamic_fields: (() => {
          ...
          >
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction
                ...
                style={{
                  background: confirmDialog.actionStyle === 'destructive' 
