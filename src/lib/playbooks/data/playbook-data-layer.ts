...
export class PlaybookDataLayer {
   ...
   */
  async createPlaybookDefinition(data: Omit<PlaybookDefinition, 'id' | 'organization_id' | 'created_at' | 'updated_at'>): Promise<PlaybookDefinition> {
   ...
   */
  async queryPlaybookDefinitions(options: PlaybookQueryOptions = {}): Promise<PlaybookDataResult<PlaybookDefinition>> {
    this.ensureOrganizationContext();
   ...
   */
  async updatePlaybookDefinition(id: string, updates: Partial<PlaybookDefinition>): Promise<PlaybookDefinition> {
    this.ensureOrganizationContext();
   ...
   */
  async createStepDefinition(data: Omit<StepDefinition, 'id' | 'organization_id' | 'created_at' | 'updated_at'>): Promise<StepDefinition> {
    this.ensureOrganizationContext();
   ...
   */
  async queryStepDefinitions(options: PlaybookQueryOptions = {}): Promise<PlaybookDataResult<StepDefinition>> {
    this.ensureOrganizationContext();
   ...
   * Query playbook runs
   */
  async queryPlaybookRuns(options: PlaybookQueryOptions = {}): Promise<PlaybookDataResult<PlaybookRun>> {
    this.ensureOrganizationContext();
    ...
    const data = result.data?.map(transaction => this.mapTransactionToPlaybookRun(transaction)) || [];
   ...
   */
  async createStepExecution(data: Omit<StepExecution, 'id' | 'organization_id'>): Promise<StepExecution> {
    this.ensureOrganizationContext();
   ...
   */
  async queryStepExecutions(options: PlaybookQueryOptions = {}): Promise<PlaybookDataResult<StepExecution>> {
    this.ensureOrganizationContext();
   ...
   */
  async saveContract(data: Omit<PlaybookContract, 'id' | 'organization_id' | 'created_at' | 'updated_at'>): Promise<PlaybookContract> {
    this.ensureOrganizationContext();
   ...
   */
  async createRelationship(data: Omit<PlaybookRelationship, 'id' | 'organization_id'>): Promise<PlaybookRelationship> {
    this.ensureOrganizationContext();
   ...
   * Query relationships
   */
  async queryRelationships(options: PlaybookQueryOptions = {}): Promise<PlaybookDataResult<PlaybookRelationship>> {
    this.ensureOrganizationContext();
  ...
  private mapDynamicDataToContract(dynamicData: any): PlaybookContract {
    return {
      ...
      value_json: typeof dynamicData.field_value_text === 'string' 
