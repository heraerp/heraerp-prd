...
export const salonTheme = {
  ...
  components: {
    ...
    button: {
      ...
      secondary:
        'bg-gradient-to-r from-rose-400 to-amber-400 hover:from-rose-500 hover:to-amber-500',
      accent:
...
export const salonClasses = {
  // Page backgrounds
  pageGradient:
    'bg-gradient-to-br from-purple-50 via-pink-50 to-white dark:from-gray-900 dark:via-purple-950/20 dark:to-gray-900',
  ...
  // Button styles
  primaryButton:
    'bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-medium shadow-lg shadow-purple-500/25 hover:shadow-xl hover:shadow-purple-500/30 transition-all duration-200',

  secondaryButton:
    'bg-gradient-to-r from-rose-400 to-amber-400 hover:from-rose-500 hover:to-amber-500 text-white font-medium shadow-lg shadow-rose-500/25',

  // Status badges
  statusBadge: (status: string) => {
    const statusClasses =
      salonTheme.components.status[status as keyof typeof salonTheme.components.status]
  ...
  // Input fields
  input:
    'bg-white dark:bg-gray-900 border-purple-200 dark:border-purple-800 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 dark:focus:border-purple-400 transition-colors',

  // Navigation items
  navItem:
    'px-4 py-2 rounded-lg transition-all duration-200 hover:bg-gradient-to-r hover:from-purple-100/50 hover:to-pink-100/50 dark:hover:from-purple-900/30 dark:hover:to-pink-900/30',

  navItemActive:
    'px-4 py-2 rounded-lg bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/50 dark:to-pink-900/50 font-medium',
  ...
  // Glass effect
  glass:
    'bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-purple-200/20 dark:border-purple-800/20',

  // Hover effects
  hoverGlow:
    'hover:shadow-lg hover:shadow-purple-500/20 dark:hover:shadow-purple-400/20 transition-all duration-300'
}
