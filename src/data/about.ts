...
export const APPROACH: { title: string; desc: string }[] = [
  { title: "Customer Outcomes", desc: "We start from measurable business results and work backwards." },
  { title: "Security & Privacy", desc: "We treat data protection as a first-class responsibility." },
  { title: "Configurability", desc: "Products adapt to unique workflows without custom code sprawl." },
  { title: "Interoperability", desc: "Open integration points to connect the tools you already use." },
...
export const MILESTONES: { year: string; title: string; desc: string }[] = [
  { year: "2025", title: "Public preview", desc: "First customers onboarded across multiple industries." },
  { year: "2025 Q4", title: "Partner network", desc: "Approved accounting partners in EMEA, APAC and GCC." },
