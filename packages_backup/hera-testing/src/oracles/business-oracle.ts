...
export class BusinessOracle {
   ...
   */
  static validateJournalBalance(lines: Array<{ debit: number; credit: number }>): boolean {
   ...
   */
  static validateStatusProgression(
