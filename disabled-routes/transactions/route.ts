...
/**
 * Universal financial management module - transactions API
...
export async function GET(request: NextRequest) {
  try {
    ...
    const entities = await heraApi.getEntities('financial_transactions', {
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('FINANCIAL transactions creation error:', error)
    return NextResponse.json(
