-- =====================================================================
-- HERA GL Balance Trigger - Ready for Supabase Deployment
-- =====================================================================
...
-- 
-- Appointments, POS sales, and other operational transactions are ignored
-- =====================================================================
...
-- Create the trigger with WHEN condition for performance
-- Only fires for GL lines (smart_code contains '.GL.')
