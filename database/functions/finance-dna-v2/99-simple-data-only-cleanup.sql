-- Finance DNA v2 - Simple Data-Only Cleanup
-- Smart Code: HERA.ACCOUNTING.CLEANUP.SIMPLE.DATA.ONLY.v2
...
-- Log successful completion (only if constraints allow)
BEGIN;
...
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE 'Could not log completion due to constraints: %', SQLERRM;
END;
