...
- generic:
  ...
  - alert
  - listbox [ref=e11]:
    - option "All Clients" [active] [selected] [ref=e12] [cursor=pointer]:
      - img [ref=e15] [cursor=pointer]
      - generic [ref=e17] [cursor=pointer]: All Clients
    - option "Active" [ref=e18] [cursor=pointer]:
      - generic [ref=e20] [cursor=pointer]: Active
    - option "Inactive" [ref=e21] [cursor=pointer]:
      - generic [ref=e23] [cursor=pointer]: Inactive
    - option "VIP" [ref=e24] [cursor=pointer]:
      - generic [ref=e26] [cursor=pointer]: VIP
    - option "Blacklisted" [ref=e27] [cursor=pointer]:
      - generic [ref=e29] [cursor=pointer]: Blacklisted
```