/**
 * Products Guardrails Tests
 * 
 * Generated by HERA Hook-Driven Module Generator
 * Tests API v2 guardrails validation for products
 */

import { describe, it, expect, beforeAll } from 'vitest'
import { heraCommand } from '@/lib/hera/client'

describe('Products Guardrails Validation', () => {
  ...
  it('should accept valid Smart Code patterns', async () => {
    const validPayload = {
      ...
      p_data: {
        entity_type: "PRODUCT",
        entity_name: "Valid Test Products",
        smart_code: "HERA.RETAIL.PRODUCT.v1",
        organization_id: testOrgId,
        dynamic_fields: [
          {
            ...
            smart_code: "HERA.RETAIL.PRODUCT.DYN.TEST_FIELD.v1"
          }
        ]
      }
    }
