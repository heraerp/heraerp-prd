...
describe('POS integration hardening', () => {
  ...
  it('handles complex multi-item, multi-payment scenarios', async () => {
    const ticket = {
      ...
      taxTotal: 13.75,
      items: [
        { name: 'Premium Cut', qty: 1, price: 150, entity_id: 'srv-001' },
        { name: 'Hair Color', qty: 1, price: 80, entity_id: 'srv-002' },
        { name: 'Styling Product', qty: 2, price: 21, entity_id: 'prd-001' }
      ],
      payments: [
